...
Generated on: 2026-04-14T14:51:00.079569
...
- Pred: `StadtEnergie Holding` , Gold: `StadtEnergie Holding`)
...
- Pred: `Milan Händlein` , Gold: `Milan Händlein`)
...
- Pred: `Enns Werkal GMBH` , Gold: `Enns Werkal GMBH`)
...
- Pred: `Finanzamt Wien 1/23` , Gold: `Finanzamt Wien 1/23`)
...
- Pred: `Okur Automotive` , Gold: `Okur Automotive`)
...
- Pred: `Leiss Software` , Gold: `Leiss Software`)
...
- Pred: `Kök & Heberlein Bau` , Gold: `Kök & Heberlein Bau`)
...
- Pred: `Krolitzki Beratung` , Gold: `Krolitzki Beratung`)
...
- Pred: `Grönemeier&Hövelberndt E‑Commerce` , Gold: `Grönemeier&Hövelberndt E‑Commerce`)
...
- Pred: `WaldTouristik Technologien` , Gold: `WaldTouristik Technologien`)
...
- Pred: `Keltrizor Handel` , Gold: `Keltrizor Handel`)
...
- Pred: `FA Tirol Ost` , Gold: `FA Tirol Ost`)
...
- Pred: `Hörup Gastronomie AG` , Gold: `Hörup Gastronomie AG`)
...
- Pred: `Klein-Vorholt KI GMBH` , Gold: `Klein-Vorholt KI GMBH`)
...
- Pred: `Finanzamt Judenburg Liezen` , Gold: `Finanzamt Judenburg Liezen`)
...
- Pred: `FA Graz-Stadt` , Gold: `FA Graz-Stadt`)
...
- Pred: `Gogel Daten GMBH` , Gold: `Gogel Daten GMBH`)
...
- Pred: `See Garttalder` , Gold: `See Garttalder`)
...
- Pred: `Laskowsky Umwelt` , Gold: `Laskowsky Umwelt`)
...
- Pred: `FA Deutschlandsberg Leibnitz Voitsberg` , Gold: `FA Deutschlandsberg Leibnitz Voitsberg`)
...
- Pred: `Zumholte Verlag OG` , Gold: `Zumholte Verlag OG`)
...
- Pred: `DGCV E‑Commerce GMBH` , Gold: `DGCV E‑Commerce GMBH`)
...
- Pred: `VOLKSBANK WIEN` , Gold: `VOLKSBANK WIEN`)
...
- Pred: `UGQQ Verlag OG` , Gold: `UGQQ Verlag OG`)
...
- Pred: `Finanzamt Vorarlberg` , Gold: `Finanzamt Vorarlberg`)
...
- Pred: `Finanzamt Baden Mödling` , Gold: `Finanzamt Baden Mödling`)
...
- Pred: `Steinfurtglanz-Landwirtschaft` , Gold: `Steinfurtglanz-Landwirtschaft`)
...
- Pred: `RNV Digital` , Gold: `RNV Digital`)
...
- Pred: `Pfendtner Textil` , Gold: `Pfendtner Textil`)
...
- Pred: `Raiffeisen Rionalbank Hall in Tirol` , Gold: `Raiffeisen Rionalbank Hall in Tirol`)
...
- Pred: `Psomadakis Touristik` , Gold: `Psomadakis Touristik`)
...
- Pred: `Donau-Druck` , Gold: `Donau-Druck`)
...
- Pred: `FA Purkersdorf` , Gold: `FA Purkersdorf`)
...
- Pred: `Mur Alver OG` , Gold: `Mur Alver OG`)
...
- Pred: `Zoruniglanz` , Gold: `Zoruniglanz`)
...
- Pred: `FA Waldviertel` , Gold: `FA Waldviertel`)
...
- Pred: `FA Braunau Ried Schärding` , Gold: `FA Braunau Ried Schärding`)
...
- Pred: `Finanzamt Graz-Stadt` , Gold: `Finanzamt Graz-Stadt`)
...
- Pred: `Finanzamt Gmunden Vöcklabruck` , Gold: `Finanzamt Gmunden Vöcklabruck`)
