...
Generated on: 2026-09-24T14:51:17.361310
...
| Test documents | 792 |
| Train sentences | 7018 |
| Validation sentences | 1839 |
...
| Metric | Value |
|---|---|
| Accuracy (exact match) | 81.0% |
| True Positives | 787 |
| False Positives | 5800 |
| False Negatives | 17392 |
| Total Gold Entities | 18179 |
| Micro Precision | 11.9% |
| Micro Recall | 4.3% |
| Micro F1 | 6.4% |
| Macro F1 | 6.4% |
...
| `VwGH_Abbreviation` | 0.0% | 0.0% | 0.0% | 5530 | 0 | 5530 |
...
**Rule ID:** `5952d33c`  
**Description:**
Matches corporate names with hyphens, plus signs, or ampersands, including 'GmbH & Co KG' and 'AG' suffixes.

**Content:**
```
(?<![\w])([A-Z][a-zA-Z]+(?:-[A-Z][a-zA-Z]+)+|[A-Z][a-zA-Z]+(?:\+[A-Z][a-zA-Z]+)+|[A-Z][a-zA-Z]+(?:\s*&\s*[A-Z][a-zA-Z]+)+)\s+(?:GmbH\s*&\s*Co\s*KG|GmbH|AG|Aktiengesellschaft|Gesellschaft\s+mbH)\b
```
...
| Precision | Recall | F1 | Total Predicted | TP | FP |
|---|---|---|---|---|---|
| 0.000 | 0.000 | 0.000 | 5530 | 0 | 5530 |

**Per-Class Breakdown**

| Class | TP | FP | FN |
|---|---|---|---|
| `organisation` | 0 | 5530 | 18179 |
...
**Example 0** (doc_id: `deanon_BFG_20260814_TRAIN/127180.1`) (sent_id: `deanon_BFG_20260814_TRAIN/127180.1_43`)


Der Beschwerdeführerin wurde vertraglich das Optionsrecht eingeräumt, durch einseitige Erklärung ein inhaltlich vorausbestimmtes Schuldverhältnis in Geltung zu setzen (vgl in diesem Sinne etwa VwGH 31.5.1995, 94/16/0237).
...
**Example 1** (doc_id: `deanon_BFG_20260814_TRAIN/127180.1`) (sent_id: `deanon_BFG_20260814_TRAIN/127180.1_45`)


Ohne Relevanz ist es in diesem Fall, ob die Option von der Beschwerdeführerin bereits ausgeübt wurde bzw ob sie überhaupt ausgeübt wird, weil die Ausübung der Option eine gebührenrechtlich unbeachtliche Potestativbedingung iSd § 17 Abs 4 GebG darstellt (vgl VwGH 31.5.1995, 94/16/0237;
...
**Example 2** (doc_id: `deanon_BFG_20260814_TRAIN/127180.1`) (sent_id: `deanon_BFG_20260814_TRAIN/127180.1_48`)


Diese rechtliche Beurteilung gilt klar auch für Optionen, durch deren Ausübung ein bestehender Vertrag verlängert oder ein neuer Vertrag abgeschlossen wird (VwGH 12.9.2017, Ra 2015/16/0061).
...
**Example 4** (doc_id: `deanon_BFG_20260814_TRAIN/128627.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128627.1_22`)


Es wurde im Schreiben auf die VwGH-Entscheidung hinsichtlich  Sportvereine (Gz. 2005/13/0128) verwiesen.
...
**Example 6** (doc_id: `deanon_BFG_20260814_TRAIN/128627.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128627.1_152`)


Es ist dabei unerheblich,  ob die Leistungen tatsächlich in Anspruch genommen werden (vgl. Erkenntnis VwGH 4.6.2008,  2005/13/0128).
...
**Example 7** (doc_id: `deanon_BFG_20260814_TRAIN/128627.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128627.1_183`)


auch weicht die Entscheidung nicht von der Rechtsprechung des VwGH ab (vgl. VwGH  4.6.2008, 2005/13/0128).
...
**Example 8** (doc_id: `deanon_BFG_20260814_TRAIN/128730.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128730.1_34`)


Es hat von Amts  wegen ein weiterer Zinsenbescheid zu ergehen, ohne dass eine Abänderung des  ursprünglichen Zinsenbescheides zu erfolgen hat (VwGH 28.5.2009, 2006/15/0316, 0332).
...
**Example 9** (doc_id: `deanon_BFG_20260814_TRAIN/128730.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128730.1_38`)
...
**Example 10** (doc_id: `deanon_BFG_20260814_TRAIN/128755.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128755.1_34`)


Behörde - neu hervorgekommenen Tatsachen im Wiederaufnahmebescheid anzuführen sind  (VwGH 19.10.2016, Ra 2014/15/0058).
...
**Example 11** (doc_id: `deanon_BFG_20260814_TRAIN/128755.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128755.1_35`)


Die Rechtsfrage zur Reichweite der antragsgebundenen Wiederaufnahme nach § 303 Abs. 1 lit.  b BAO idF FVwGG 2012 und zur diesbezüglichen Bedeutung des Kenntnisstandes der Partei ist  bereits mit dem zitierten Erkenntnis VwGH 19.10.2016, Ra 2014/15/0058, beantwortet.
...
**Example 12** (doc_id: `deanon_BFG_20260814_TRAIN/128755.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128755.1_36`)
...
**Example 13** (doc_id: `deanon_BFG_20260814_TRAIN/128755.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128755.1_55`)


Die Rechtsfrage zur Reichweite der antragsgebundenen  Wiederaufnahme nach § 303 Abs. 1 lit. b BAO idF FVwGG 2012 und die Bedeutung des  Kenntnisstandes eines Antragstellers wurde bereits mit Erkenntnissen des VwGH vom  19.10.2016, Ra 2014/15/0058, beantwortet sowie mit Beschluss des VwGH vom 29.03.2017,  Ro 2016/15/0036, bekräftigt.
...
**Example 14** (doc_id: `deanon_BFG_20260814_TRAIN/128762.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128762.1_38`)


In jenem Verfahren  seien weitgehend idente Sachverhalte und insoweit dieselben Rechtsfragen strittig, weshalb  angeregt werde, das gegenständliche Verfahren gem. § 271 BAO bis zum Abschluss des beim  VwGH behängenden Verfahrens auszusetzen.
...
**Example 15** (doc_id: `deanon_BFG_20260814_TRAIN/128762.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128762.1_39`)


Tatsächlich war die Entscheidung des VwGH in dieser Sache bereits ergangen.
...
**Example 16** (doc_id: `deanon_BFG_20260814_TRAIN/128762.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128762.1_51`)


Vertrages der Veräußerer das Kostenrisiko getragen hätte (Ressler/Arnold in Arnold/Bodis  [Hrsg.], GrESt 1987, 16. Lfg., § 5 Rz 127 mit Verweis auf VwGH 23.1.2003, 2001/16/0353).
...
**Example 18** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_47`)


Die  Notwendigkeit bietet in derartigen Fällen das verlässliche Indiz der betrieblichen bzw.  beruflichen im Gegensatz zur privaten Veranlassung (VwGH 27.6.2000, 2000/14/0096, 0097;
...
**Example 19** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_48`)
...
**Example 20** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_50`)


Trägt der Arbeitgeber einen Teil der Kurskosten oder  stellt er den Arbeitnehmer für die Zeit der Schulungsmaßnahme gegen Weiterbezug des  Gehalts dienstfrei, ist dies gleichfalls ein Indiz für die berufliche Notwendigkeit (VwGH  31.3.2011, 2009/15/0198).
...
**Example 21** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_52`)


In Bezug auf Aufwendungen für die Persönlichkeitsentwicklung kann  dies wegen der Nähe zum Bereich der privaten Lebensführung allerdings nur dann gelten,  wenn im Rahmen der ausgeübten beruflichen Betätigung eine entsprechende (idR  psychologische) Schulung erforderlich ist (VwGH 29.3.2009, 2009/15/0197).
...
**Example 22** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_54`)


Kurse zur Vermittlung von „social skills“, die in gleicher Weise für  den Bereich der Lebensführung wie für eine breite Palette von Erwerbstätigkeiten dienlich sein  können, sind nur dann geeignet, zu Betriebsausgaben bzw. Werbungskosten zu führen, wenn  die Behörde einen konkreten Bedarf im Einzelfall festzustellen vermag (VwGH 31.5.2011,  2008/15/0226).
...
**Example 23** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_55`)
...
**Example 24** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_70`)
...
**Example 25** (doc_id: `deanon_BFG_20260814_TRAIN/128776.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128776.1_71`)
...
**Example 26** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_81`)


Unter Verweis auf das zu einem  gleichgelagerten Fall ergangene Erkenntnis vom 22.10.2015, 2013/15/0277, führt der VwGH  begründend - unter Bezugnahme insbes.
...
**Example 27** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_85`)
...
**Example 28** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_119`)


VwGH 1.2.2008, 2005/15/0135;
...
**Example 29** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_120`)


VwGH 25.7.2013, 2011/15/0193;
...
**Example 30** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_121`)


VwGH 29.1.2015, Ra  2014/15/0059).
...
**Example 31** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_159`)


2. Nach ständiger Rechtsprechung des VwGH genügt, wenn im Rahmen der freien  Beweiswürdigung nach § 167 Abs. 2 BAO von mehreren Möglichkeiten jene als erwiesen  angenommen wird, die gegenüber allen anderen eine überragende Wahrscheinlichkeit für sich  hat und die anderen Möglichkeiten weniger wahrscheinlich erscheinen lässt (siehe  beispielsweise VwGH 23.9.2010, 2010/15/0078).
...
**Example 32** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_161`)


3. zur Verjährung:  Gemäß § 207 Abs. 2 BAO beträgt die Verjährungsfrist betreffend die Umsatzsteuer fünf Jahre  (vgl. VwGH 18.10.2007, 2005/15/0017) und beginnt gemäß § 208 Abs. 1 lit a BAO mit dem  Ablauf des Jahres, in dem der Abgabenanspruch entstanden ist.
...
**Example 33** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_178`)


Auch die tatsächliche  Nutzung des Fahrzeuges kann als Indiz für die beim Erwerb vorgelegene Verwendungsabsicht  herangezogen werden (vgl. VwGH 26.1.2012, 2009/15/0177).
...
**Example 34** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_197`)


Auch nach Auffassung des VwGH gehört zu den  Bemessungsgrundlagen notwendigerweise der Zeitraum, für den die jeweiligen Abgaben  vorgeschrieben werden (VwGH 16.9.1992, 88/13/0224;
...
**Example 35** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_198`)


VwGH 18.6.1993, 90/17/0339).
...
**Example 36** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_201`)
...
**Example 37** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_214`)


3. Ob ein innergemeinschaftlicher Erwerb iSd Art. 1 Abs. 1 UStG 1994 des in Rede stehenden  Fahrzeuges in Österreich oder eine innerstaatliche Lieferung in Italien vorliegt, richtet sich  danach, ob der erworbene Gegenstand das Gebiet des Liefermitgliedstaats tatsächlich  verlassen hat und, wenn ja, in welchem Mitgliedstaat der Endverbrauch des Fahrzeuges erfolgt  ist (vgl. VwGH vom 22.10.2015, 2013/15/0277).
...
**Example 38** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_225`)


Der Begriff „Sache“ iSd § 279 BAO knüpft damit an  den Inhalt des Spruches an (vgl. etwa VwGH 12.6.2019, Ro 2017/13/0016).
...
**Example 39** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_230`)


Aufgrund der Entstehung der Steuerschuld im September 2005 ist daher die Umsatzsteuer für  diesen Zeitraum festzusetzen, welche Abänderung nach oben dargelegter VwGH-RSpr als  zulässig erachtet wird (vgl. VwGH vom 11.9.2014, 2013/16/0156).
...
**Example 40** (doc_id: `deanon_BFG_20260814_TRAIN/128782.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128782.1_238`)


Die Vermeidung einer wirtschaftlichen Doppelbelastung mit Umsatzsteuer hat im  Ursprungsland durch Gewährung des Vorsteuerabzugs zu erfolgen (VwGH vom 25.1.2006,  2001/14/0125).
...
**Example 41** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_165`)


Um einen Wohnsitz im Sinne der  Abgabenvorschriften zu begründen, bedarf es der tatsächlichen Verfügungsgewalt über  bestimmte Räumlichkeiten, die nach der Verkehrsauffassung zum Wohnen geeignet sind, also  ohne Änderung jederzeit zum Wohnen benutzt werden können und ihrem Inhaber nach Größe  und Ausstattung ein den persönlichen Verhältnissen entsprechendes Heim bieten (vgl. VwGH  3.11.2005, 2002/15/0102).
...
**Example 42** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_166`)


Für das Vorliegen eines Wohnsitzes ist also das objektive Moment  der Innehabung unter den in § 26 BAO genannten Umständen maßgebend (vgl. VwGH  20.6.1990, 89/16/0020).
...
**Example 43** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_197`)


Loukota/Jirousek, Internationales Steuerrecht I/1 Z 4 Rz 10, Stand  1.11.2013, rdb.at, mwN; VwGH 25.7.2013, 2011/15/0193;
...
**Example 44** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_198`)
...
**Example 45** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_199`)


VwGH 19.3.2002, 98/14/0026;
...
**Example 46** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_200`)
...
**Example 47** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_201`)


Wirtschaftliche Bindungen gehen vor allem von örtlich gebundenen Tätigkeiten und von  Vermögensgegenständen in Form von Einnahmequellen aus (vgl. VwGH 25.7.2013,  2011/15/0193, mwN).
...
**Example 48** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_203`)


Von Bedeutung sind dabei familiäre Bindungen sowie Betätigungen  gesellschaftlicher, religiöser und kultureller Art und andere Betätigungen zur Entfaltung  persönlicher Interessen und Neigungen, aber auch Verbindungen zu Sachgesamtheiten, wie  Privatsammlungen, und die Mitgliedschaft in Vereinen und andere soziale Engagements (vgl.  VwGH 25.7.2013, 2011/15/0193, mwN).
...
**Example 49** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_205`)
...
**Example 50** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_206`)
...
**Example 52** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_209`)


VwGH 25.7.2013, 2011/15/0193, mit Hinweis auf Loukota/Jirousek, Internationales  Steuerrecht I/1 Z 4 Rz 11 f, Stand 1.11.2013, rdb.at).
...
**Example 53** (doc_id: `deanon_BFG_20260814_TRAIN/128811.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128811.1_254`)
...
**Example 54** (doc_id: `deanon_BFG_20260814_TRAIN/128831.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128831.1_56`)


Hierbei muss die Behörde im Rahmen des  Schätzungsverfahrens auf alle vom Abgabepflichtigen substantiiert vorgetragenen, für die  Schätzung relevanten Behauptungen eingehen (vgl. bspw. VwGH 27.01.2016, 2012/13/0068).
...
**Example 55** (doc_id: `deanon_BFG_20260814_TRAIN/128855.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128855.1_98`)


Sollen anstelle des Freibetrages die tatsächlichen Kosten der Behinderung geltend gemacht  werden, sind sämtliche Kosten nachzuweisen bzw. glaubhaft zu machen (vgl. VwGH  18.05.1995, 93/15/0079;
...
**Example 56** (doc_id: `deanon_BFG_20260814_TRAIN/128855.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128855.1_100`)
...
**Example 57** (doc_id: `deanon_BFG_20260814_TRAIN/128855.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128855.1_103`)


Aufwendungen werden durch die tarifliche Steuerfreistellung des pauschalen  Existenzminimums in § 33 Abs. 1 EStG 1988 berücksichtigt (vgl. VwGH vom 30. März 2016,  2013/13/0063, mwN).“
...
**Example 58** (doc_id: `deanon_BFG_20260814_TRAIN/128855.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128855.1_130`)
...
**Example 59** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_42`)


Aus Sicht des FA sei  jedoch unter Bezugnahme auf die Judikatur des VwGH eine Reduktion der Haftung aus diesen  Gründen ebenfalls nicht möglich.
...
**Example 60** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_95`)


Unter Haften ist das „Einstehen müssen für fremde Abgabenschulden“ zu verstehen (zB VwGH  20.4.1989, 89/16/0009-0011).
...
**Example 61** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_111`)


sie ist daher nur innerhalb der  Einhebungsverjährungsfrist (§ 238) zulässig (zB VwGH 30.3.1998, 97/16/0501;
...
**Example 63** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_132`)


Das Unterbleiben einer  solchen Bekanntmachung macht den Haftungsbescheid rechtswidrig ( VwGH 28.5.1993,  93/17/0049;
...
**Example 64** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_142`)


Dies gilt unabhängig davon, ob die betreffende  Person tatsächlich als Geschäftsführer tätig ist oder zB nur ein „Pro-forma-Geschäftsführer“  (VwGH 2.7.2002, 99/14/0076;
...
**Example 65** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_143`)


16.10.2014, Ra 2014/16/0026) oder „nur auf dem Papier“  (VwGH 19.1.2005, 2001/13/0168;
...
**Example 66** (doc_id: `deanon_BFG_20260814_TRAIN/128871.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128871.1_165`)
...
**Example 68** (doc_id: `deanon_BFG_20260814_TRAIN/128877.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128877.1_33`)


Der Zeitpunkt, in dem die Daten in den elektronischen Verfügungsbereich des Empfängers  gelangt sind, ist bei FinanzOnline der Zeitpunkt der Einbringung der Daten in die Databox, zu  der der Empfänger Zugang hat (ErlRV 270 BlgNR XXIII. GP 13; VwGH 31.07.2013,  2009/13/0105).
...
**Example 69** (doc_id: `deanon_BFG_20260814_TRAIN/128877.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128877.1_52`)


Diese  Bestimmung sieht telefonische Anbringen nicht vor, sodass telefonische Mitteilungen auch  keine "mündlichen" Anbringen im Sinne des § 85 BAO sind (VwGH 31.3.2005, 2004/15/0089).
...
**Example 70** (doc_id: `deanon_BFG_20260814_TRAIN/128877.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128877.1_53`)
...
**Example 71** (doc_id: `deanon_BFG_20260814_TRAIN/128877.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128877.1_61`)
...
**Example 72** (doc_id: `deanon_BFG_20260814_TRAIN/128893.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128893.1_70`)


Der Abzug eines  Selbstbehaltes ergibt sich zwingend aus § 34 Abs. 4 EStG 1988 (vgl. VwGH 30.1.2001,  2000/14/0184).
...
**Example 73** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_94`)
...
**Example 74** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_95`)


Daran hat sich durch die Verwaltungsgerichtsbarkeitsreform  nichts geändert (vgl. VwGH 27.2.2019, Ra 2017/15/0015 unter Hinweis auf VwGH 30.5.2017,  Ra 2016/16/0087;
...
**Example 76** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_106`)
...
**Example 77** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_109`)


25.6.2007,  2004/17/0105), die nur er aufklären kann, oder wenn seine Behauptungen mit den  Erfahrungen des täglichen Lebens in Widerspruch stehen (VwGH 22.1.1992, 90/13/0200;
...
**Example 78** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_113`)


Im Hinblick auf  seine eigene Nähe zum Beweisthema hat hier der Beschwerdeführer von sich aus  nachzuweisen oder zumindest glaubhaft zu machen, dass sie – entgegen allgemeinen  Lebenserfahrung – die steuerlich relevante Sphäre betreffen (vgl. etwa VwGH 22.2.07,  2006/14/0020).
...
**Example 79** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_114`)


Im Übrigen befreit der Grundsatz der Amtswegigkeit des Verfahrens den Revisionswerber nicht  von seiner Verpflichtung, zur Ermittlung des maßgebenden Sachverhaltes beizutragen (VwGH  25.7.2018, Ro 2016/13/0031 mit weiteren Nachweisen).
...
**Example 80** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_131`)


Der Ansatz des allgemeinen Freibetrages scheidet damit hier aus (vgl. VwGH  23.1.2019, Ro 2016/13/0010).
...
**Example 81** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_146`)


Es liegt im Wesen einer Pauschalierung, zum Zweck der Vereinfachung der Steuererhebung  nicht auf die Verhältnisse des Einzelfalls abzustellen (vgl. VwGH 30.9.2015, 2012/15/0125 zur  Durchschnittssatzverordnung für Werbungskosten).
...
**Example 82** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_178`)


Müssten deshalb aus Krankheitsgründen teurere Lebensmittel  konsumiert werden, um dem Körper den lebensnotwendigen Nährwert zuzuführen, so ist (nur)  der dadurch entstehende Mehraufwand außergewöhnlich (vgl. VwGH 31.5.2017, Ro  2015/13/0023).
...
**Example 83** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_181`)


Grundsätzlich ist die Höhe dieses Mehraufwandes nachzuweisen, sie kann allerdings unter  Umständen auch im Schätzungsweg ermittelt werden, wenn der Steuerpflichtige das Zutreffen  der gesetzlichen Voraussetzungen zwar dem Grunde, nicht aber der Höhe nach beweisen kann  (vgl. VwGH 31.5.2017, Ro 2015/13/0023 unter Hinweis auf VwGH 27.2.2008, 2004/13/0116).
...
**Example 84** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_183`)


Die  Aufwendungen müssen vielmehr zwangsläufig erwachsen, womit es erforderlich ist, dass die  Maßnahmen zur Heilung oder Linderung einer Krankheit nachweislich notwendig ist (Hinweis  auf VwGH 22.12.2004, 2001/15/0116).
...
**Example 85** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_185`)


Kosten von ohne eine konkrete ärztliche Verordnung eingenommenen  Vitaminpräparaten und Nahrungsergänzungsmitteln etwa stellen keine außergewöhnliche  Belastung dar (VwGH 10.2.2016, 2013/15/0254 und 0255).
...
**Example 86** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_210`)
...
**Example 87** (doc_id: `deanon_BFG_20260814_TRAIN/128943.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128943.1_211`)
...
**Example 88** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_21`)
...
**Example 89** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_25`)


Unter diesen Umständen haften Sie für die uneinbringlichen  Abgabenschuldigkeiten im vollen Ausmaß (zB VwGH 22.12.2005, 2005/15/0114).
...
**Example 90** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_26`)
...
**Example 91** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_28`)
...
**Example 92** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_62`)
...
**Example 93** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_63`)
...
**Example 94** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_65`)
...
**Example 96** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_71`)


Der Zeitpunkt, für den zu beurteilen ist, ob der Vertretene die für die Abgabenentrichtung  erforderlichen Mittel hatte, bestimmt sich danach, wann die Abgaben bei Beachtung der  abgabenrechtlichen Vorschriften zu entrichten gewesen wären (VwGH 23.1.2003,  2001/16/0291).
...
**Example 97** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_72`)


Das „Erfordernis der Gleichbehandlung aller Gläubiger der Gesellschaft“ durch deren Vertreter  ergibt sich erst als Folge des vom Vertreter im Haftungsverfahren dar zu tuenden Fehlens  ausreichender Mittel zur Befriedigung der Abgabenverbindlichkeiten (VwGH 25.4.2002,  99/15/0253).
...
**Example 98** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_73`)


Nur der Vertreter wird in der Regel jenen ausreichenden Einblick in die Gebarung des  Vertretenen haben, der ihm entsprechende Behauptungen und Nachweise ermöglicht (VwGH  5.4.2011, 2009/16/0106).
...
**Example 99** (doc_id: `deanon_BFG_20260814_TRAIN/128966.1`) (sent_id: `deanon_BFG_20260814_TRAIN/128966.1_74`)


Die Abgabenbehörde ist nicht gehalten, im Wege einer Schätzung  auf das Ausmaß der Ungleichbehandlung zu schließen, wenn dazu kein konkretes Vorbringen  erstattet wird (VwGH 24.2.2010, 2005/13/0124).
