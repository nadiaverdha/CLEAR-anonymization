...
Generated on: 2026-09-23T16:43:28.364365
...
```
 python benchmark.py --config reports/ris_train/Qwen_Qwen3.5-35B-A3B/person/2026-09-23_v1/config.yaml 
```
| Parameter | Value |
|---|---|
| Pool size | 200 |
...
|---|---|---|---|---|---|---|
| `German Legal Person (Titles)` | 77.5% | 88.3% | 69.1% | 3265 | 2884 | 381 |
| `German Legal Person (Standalone Names)` | 0.2% | 36.4% | 0.1% | 11 | 4 | 7 |
| `German Legal Person (Frau/Herr Context)` | 0.0% | 0.0% | 0.0% | 0 | 0 | 0 |
| `German Legal Person (Context: In der Beschwerdesache)` | 0.0% | 0.0% | 0.0% | 0 | 0 | 0 |
...
**F1:** 0.775 | **Precision:** 0.883 | **Recall:** 0.691  

**Format:** `regex`  
**Rule ID:** `94626f7a`  
**Description:**
Matches academic/professional titles followed by a valid name, explicitly handling consecutive titles, hyphenated surnames, and accented characters.

**Content:**
```
(?:Dr\.|Mag\.|Mag\.\s+Dr\.|Dr\.\s+Mag\.|Priv\.-Doz\.|Priv\.-Doz\.in|Univ\.-Prof\.|Univ\.-Prof\.in|Hon\.-Prof\.|Hon\.-Prof\.in|PhD|OSR|VetR|KommR|Bakk\.\s+phil\.|LLB|BSc|Dipl\.-Ing\.|Dipl\.-Ing\.in|DDr\.|DDr\.in|Mag\.\s+MBA\s+MSc|Mag\.\s+MSc|Mag\.\s+MBA|Mag\.\s+in|Mag\.a|Dr\.in|Ing\.|RgR|\u00d6kR|Techn\s+R|Prof\.|Prof\.\s+Dr\.|Dr\.\s+Prof\.|PD\s+Dr\.|Dr\.\s+PD\.|MMag\.|MMag\.\s+Dr\.|DI\.|DI\s+Dr\.|Dr\.\s+DI\.|Dipl\.\s+Dr\.|Dr\.\s+Dipl\.|OStR|OMedR|StR|Bgm\.\s+Dr\.|Dr\.\s+Bgm\.)\s+(?:(?:Dr\.|Mag\.|Priv\.-Doz\.|Univ\.-Prof\.|Hon\.-Prof\.|PD\s+Dr\.|MMag\.|DI\.|Dipl\.)\s+)*([A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe\u00c4\u00d6\u00dc\u00c9\u00e9\u00e8\u00ea\u00ee\u00f4\u00fb]+(?:\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe\u00c4\u00d6\u00dc\u00c9\u00e9\u00e8\u00ea\u00ee\u00f4\u00fb]+)*(?:\s+-\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe\u00c4\u00d6\u00dc\u00c9\u00e9\u00e8\u00ea\u00ee\u00f4\u00fb]+)*)
```
...
|---|---|---|---|---|---|
| 0.883 | 0.691 | 0.775 | 3265 | 2884 | 381 |

**Per-Class Breakdown**

| Class | TP | FP | FN |
|---|---|---|---|
| `person` | 2884 | 381 | 1291 |
...
| `Mag. Schober` | `Mag. Schober` |
| `Dr. Annerl` | `Dr. Annerl` |
| `DDr.in Cornelia Rinaldo` | `DDr.in Cornelia Rinaldo` |
...
**Example 49** (doc_id: `deanon_260716_TRAIN/10Ob2_14p`) (sent_id: `deanon_260716_TRAIN/10Ob2_14p_81`)
...
| Predicted | Gold |
|---|---|
| `DDr.in Helena Jakobskötter` | `DDr.in Helena Jakobskötter` |
...
| `Dr. Schramm` | `Dr. Schramm` |
| `Dr. Fichtenau` | `Dr. Fichtenau` |
| `DI Dr. Bodo Kaczynski` | `DI Dr. Bodo Kaczynski` |
...
- `Hon.-Prof.in Kzl` — partial — pred is substring of gold: `Hon.-Prof.in KzlR Iris Makowska`
...
**Example 1** (doc_id: `deanon_260716_TRAIN/10Ob10_10h`) (sent_id: `deanon_260716_TRAIN/10Ob10_10h_3`)
...
**Example 2** (doc_id: `deanon_260716_TRAIN/10Ob11_11g`) (sent_id: `deanon_260716_TRAIN/10Ob11_11g_15`)
...
**Example 3** (doc_id: `deanon_260716_TRAIN/10Ob11_11g`) (sent_id: `deanon_260716_TRAIN/10Ob11_11g_19`)
...
**Example 5** (doc_id: `deanon_260716_TRAIN/10Ob16_24m`) (sent_id: `deanon_260716_TRAIN/10Ob16_24m_3`)
...
**Example 6** (doc_id: `deanon_260716_TRAIN/10Ob18_25g`) (sent_id: `deanon_260716_TRAIN/10Ob18_25g_3`)
...
**Example 7** (doc_id: `deanon_260716_TRAIN/10Ob24_15z`) (sent_id: `deanon_260716_TRAIN/10Ob24_15z_3`)
...
**Example 8** (doc_id: `deanon_260716_TRAIN/10Ob26_14t`) (sent_id: `deanon_260716_TRAIN/10Ob26_14t_5`)
...
**Example 9** (doc_id: `deanon_260716_TRAIN/10Ob2_10g`) (sent_id: `deanon_260716_TRAIN/10Ob2_10g_9`)
...
**Example 10** (doc_id: `deanon_260716_TRAIN/10Ob2_14p`) (sent_id: `deanon_260716_TRAIN/10Ob2_14p_3`)
...
**Example 11** (doc_id: `deanon_260716_TRAIN/10Ob32_22m`) (sent_id: `deanon_260716_TRAIN/10Ob32_22m_3`)
...
**Example 12** (doc_id: `deanon_260716_TRAIN/10Ob38_25y`) (sent_id: `deanon_260716_TRAIN/10Ob38_25y_3`)
...
**Example 13** (doc_id: `deanon_260716_TRAIN/10Ob42_15x`) (sent_id: `deanon_260716_TRAIN/10Ob42_15x_5`)
...
**Example 14** (doc_id: `deanon_260716_TRAIN/10Ob57_13z`) (sent_id: `deanon_260716_TRAIN/10Ob57_13z_10`)
...
- `KommR Techn` — partial — pred is substring of gold: `KommR Techn R Elmira Roßmeir`
...
**Example 16** (doc_id: `deanon_260716_TRAIN/10ObS99_15d`) (sent_id: `deanon_260716_TRAIN/10ObS99_15d_3`)
...
**Example 17** (doc_id: `deanon_260716_TRAIN/11Os140_11i`) (sent_id: `deanon_260716_TRAIN/11Os140_11i_3`)
...
**Example 18** (doc_id: `deanon_260716_TRAIN/11Os67_16m`) (sent_id: `deanon_260716_TRAIN/11Os67_16m_3`)
...
**Example 19** (doc_id: `deanon_260716_TRAIN/11Os91_18v`) (sent_id: `deanon_260716_TRAIN/11Os91_18v_4`)
...
**Example 20** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_3`)
...
**Example 21** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_4`)
...
**Example 22** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_6`)
...
**Example 23** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_12`)
...
**Example 24** (doc_id: `deanon_260716_TRAIN/12Ns22_16f`) (sent_id: `deanon_260716_TRAIN/12Ns22_16f_5`)
...
**Example 25** (doc_id: `deanon_260716_TRAIN/12Ns22_16f`) (sent_id: `deanon_260716_TRAIN/12Ns22_16f_11`)
...
**Example 26** (doc_id: `deanon_260716_TRAIN/12Ns4_15g`) (sent_id: `deanon_260716_TRAIN/12Ns4_15g_5`)
...
## `German Legal Person (Standalone Names)` 💣

**F1:** 0.002 | **Precision:** 0.364 | **Recall:** 0.001  

**Format:** `regex`  
**Rule ID:** `304f2f31`  
**Description:**
Captures full names (First Last) or single surnames that appear without titles, specifically in contexts like 'durch den Senatspräsidenten [Name]' or 'des Zeugen [Name]'. Excludes common legal nouns.

**Content:**
```
(?:durch\s+(?:den|die|der|des)\s+(?:Senatspräsident|Senatspräsidentin|Vizepräsident|Vizepräsidentin|Hofrat|Hofrätin|Hofräte|Geschäftsführer|Geschäftsführerin|Generalanwalt|Generalanwältin|Privatbeteiligte|Privatbeteiligter|Zeuge|Zeugin)|als\s+(?:Vorsitzender|Vorsitzende|Vorsitzender|Vorsitzende)|des\s+(?:Zeugen|Zeugin|Privatbeteiligten|Privatbeteiligtenin)|,\s+(?:und|sowie)\s+)([A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe]+(?:\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe]+)*(?:\s+-\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00dfe]+)*)
```
...
**Example 1** (doc_id: `deanon_260716_TRAIN/15Os110_17s`) (sent_id: `deanon_260716_TRAIN/15Os110_17s_12`)
...
**Example 2** (doc_id: `deanon_260716_TRAIN/5Ob106_20d`) (sent_id: `deanon_260716_TRAIN/5Ob106_20d_3`)
...
**Example 3** (doc_id: `deanon_260716_TRAIN/7Ob3_16s`) (sent_id: `deanon_260716_TRAIN/7Ob3_16s_3`)
...
**Example 0** (doc_id: `deanon_260716_TRAIN/1Ob55_13i`) (sent_id: `deanon_260716_TRAIN/1Ob55_13i_69`)


1 Ob 37/93, jeweils mwN), und Art 5 des Europäischen Übereinkommens über die Berechnung von Fristen, BGBl 1983/254 (EuFrÜb), das innerstaatlich unmittelbar wirksam ist, eine Ablaufhemmung.
...
**Example 1** (doc_id: `deanon_260716_TRAIN/3Ob222_17v`) (sent_id: `deanon_260716_TRAIN/3Ob222_17v_13`)


ausgeschlossen sind Arbeiten unter mehr als fallweise besonderem Zeitdruck, Arbeiten, die mit häufigem Personen- bzw Kundenkontakt verbunden sind, sowie Schicht-, Akkord- und Nachtarbeit.

**False Positives:**

- `Schicht` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 2** (doc_id: `deanon_260716_TRAIN/4Ob23_24x`) (sent_id: `deanon_260716_TRAIN/4Ob23_24x_37`)
...
- `Handel` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 3** (doc_id: `deanon_260716_TRAIN/6Ob36_20t`) (sent_id: `deanon_260716_TRAIN/6Ob36_20t_64`)


Ausdrücklich von der Einordnung als Fernabsatzvertrag ausgeschlossen wurden hingegen Verträge, welche in den Geschäftsräumen des Unternehmers verhandelt, aber über ein Fernkommunikationsmittel geschlossen wurden, und Verträge, welche über ein Fernkommunikationsmittel angebahnt, aber in den Geschäftsräumen des Unternehmers abgeschlossen wurden (ErwG 20 Verbraucherrechte-RL;IllibauerinKeiler/Klauser, Österreichisches und Europäisches Verbraucherrecht [2019] zu § 3 FAGG Rz 16).

**False Positives:**

- `Verträge` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 4** (doc_id: `deanon_260716_TRAIN/6Ob69_23z`) (sent_id: `deanon_260716_TRAIN/6Ob69_23z_49`)


Das Erstgericht hat aber – wenn auch in der rechtlichen Beurteilung – festgehalten, dass „der Willeder Beteiligten, eine Vereinbarung zwischen [Name des Komplementärs], genauer unter Benützung der Klägerin, und Fahrschule, genauer dem Einzelunternehmer Ing. Wendelin Lindle samt seinem Nachfolger [Name des Beklagten] zu treffen, [...] entscheidet“.

**False Positives:**

- `Fahrschule` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Gold Entities:**

- `Ing. Wendelin Lindle`(person)

**Example 5** (doc_id: `deanon_260716_TRAIN/7Ob201_12b`) (sent_id: `deanon_260716_TRAIN/7Ob201_12b_259`)


Damit wird auch die Abwicklung des Zahlungsverkehrs zwischen einem Unternehmer, der nicht selbst Zahlungsdienstleister ist, und Verbrauchern eingeschlossen, zumal der Verbraucherschutzgedanke in diesem Zusammenhang derselbe ist.
...
**Example 6** (doc_id: `deanon_260716_TRAIN/8Ob75_13g`) (sent_id: `deanon_260716_TRAIN/8Ob75_13g_3`)
...
- `Feststellung` — no gold match — likely missing annotation
