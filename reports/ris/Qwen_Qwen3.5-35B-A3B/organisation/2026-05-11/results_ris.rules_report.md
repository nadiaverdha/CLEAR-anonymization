...
Generated on: 2026-05-11T11:55:10.318249
...
| `Acronym_Industry_Org` | 1.5% | 1.2% | 2.0% | 585 | 7 | 578 |
...
**F1:** 0.015 | **Precision:** 0.012 | **Recall:** 0.020  

**Format:** `regex`  
**Description:**
Matches organisation names starting with an acronym (all caps) followed by an industry term, e.g., 'DCR Druck'.

**Content:**
```
\b([A-Z]{2,}\s+[A-Z][a-zA-Z\u00e4\u00f6\u00fc\u00c4\u00d6\u00dc\u00df]+)\b
```
...
| Precision | Recall | F1 | Total Predicted | TP | FP |
|---|---|---|---|---|---|
| 0.012 | 0.020 | 0.015 | 585 | 7 | 578 |

**Per-Class Breakdown**

| Class | TP | FP | FN |
|---|---|---|---|
| `organisation` | 7 | 578 | 338 |
...
**Example 0** (doc_id: `deanon_TRAIN/10Ob18_25g`) (sent_id: `deanon_TRAIN/10Ob18_25g_36`)


Ost Bruckconal gibt dabei die Zählertechnologie vor.[...] 7. Der Netzkunde stellt in seinem Bereich den erforderlichen Platz für die Messeinrichtungen auf eigene Kosten zur Verfügung und verpflichtet sich, diese nach den Anweisungen von TJE Recycling zu verwahren.

| Predicted | Gold |
|---|---|
| `TJE Recycling` | `TJE Recycling` |

**Missed by this rule (FN):**

- `Ost Bruckconal` (organisation)

**Example 1** (doc_id: `deanon_TRAIN/10Ob18_25g`) (sent_id: `deanon_TRAIN/10Ob18_25g_47`)


Bei jeder Mahnung hat ZIQ Daten auf die Möglichkeit zur Inanspruchnahme der Beratungsstelle des bestehenden Energielieferanten, soweit diese gemäß § 82 Abs 7 ElWOG einzurichten ist, hinzuweisen.
...
**Example 0** (doc_id: `deanon_TRAIN/10Nc11_19b`) (sent_id: `deanon_TRAIN/10Nc11_19b_18`)
...
**Example 1** (doc_id: `deanon_TRAIN/10Nc11_19b`) (sent_id: `deanon_TRAIN/10Nc11_19b_19`)
...
**Example 2** (doc_id: `deanon_TRAIN/10Nc24_22v`) (sent_id: `deanon_TRAIN/10Nc24_22v_28`)
...
- `II Abs` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 3** (doc_id: `deanon_TRAIN/10Nc24_22v`) (sent_id: `deanon_TRAIN/10Nc24_22v_29`)
...
**Example 4** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_5`)
...
- `EUR USt` — no gold match — likely missing annotation
...
**Example 5** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_6`)


Text Entscheidungsgründe: Nach Art III Tiroler Grundbuchsanlegungsreichsgesetz RGBl 1897/77 (TirGARG) bestehen – abweichend von § 295 ABGB – die vor der Grundbuchsanlegung in Tirol begründeten Sonderrechte an Bäumen weiter.

**False Positives:**

- `III Tiroler` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 6** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_8`)
...
- `III TirGARG` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 7** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_66`)


Session, 2 f, 5 ff;Pitreich, Zur Geschichte des Immobiliarrechtes seit der Kodifikation in: FS Jahrhundertfeier ABGB [1911] II 493).

**False Positives:**

- `FS Jahrhundertfeier` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 8** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_87`)


Die „grundbuchsrechtliche Bedeutung dieser bücherlichen Anmerkung“ solle nach den Materialien darin bestehen, dass die Rechtswirkungen der Eintragungen auf dem betroffenen Grundbuchskörper (der bepflanzten Liegenschaft) entsprechend eingeschränkt sind, also sich nicht auf jene Bäume erstrecken, die nicht als Zugehör des Grundes anzusehen sind (Artikel IV Abs. 1).

**False Positives:**

- `IV Abs` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 9** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_88`)
...
**Example 10** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_97`)


Erforderlich ist, dass sie im Grundbuchsgesetz oder einem anderen Gesetz ausdrücklich vorgesehen sind (RIS-Justiz RS0060628) wie zB die Anmerkung der Einleitung des Löschungsverfahrens nach Artikel V § 1 Abs 1 Tiroler Grundbuchsanlagungsreichsgesetz (KodekinKodek, Grundbuchsrecht2§ 20 GBG Rz 49).

**False Positives:**

- `GBG Rz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 11** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_99`)


sie können aber nie dingliche Rechte begründen, umändern oder aufheben, wie dies Einverleibungen oder Vormerkungen vermögen (KodekinKodek, Grundbuchsrecht2§ 20 GBG Rz 1 mwN).
...
**Example 12** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_103`)


Deren Rechtswirkung ist in Artikel IV Abs 1 TirGARG dahin umschrieben, dass die Wirkungen grundbücherlicher Eintragungen zur Liegenschaft (etwa Pfandrechte, Eigentumsübertragungen etc) auf die nicht als Zugehör des Grundes geltenden Bäume ausgeschlossen werden.
...
**Example 13** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_109`)
...
**Example 14** (doc_id: `deanon_TRAIN/10Ob10_18w`) (sent_id: `deanon_TRAIN/10Ob10_18w_118`)


Zudem wären bei einem Verzicht auf dingliche Rechte die jeweiligen Publizitätserfordernisse zu berücksichtigen (5 Ob 1/07v), die in der in Art IV TirGARG vorgesehenen Übergabe der Bäume an den Erwerber bestünden, wozu (ebenfalls) keine Feststellungen vorhanden sind.

**False Positives:**

- `IV TirGARG` — no gold match — likely missing annotation
...
- `DI Adolf` — partial — pred is substring of gold: `DI Adolf Kowallek`
...
**Example 16** (doc_id: `deanon_TRAIN/10Ob13_20i`) (sent_id: `deanon_TRAIN/10Ob13_20i_6`)


Die klagende Partei ist schuldig, den beklagten Parteien zu Handen der Beklagtenvertreter binnen 14 Tagen die mit 6.697,44 EUR (darin enthalten 1.116,24 EUR USt) bestimmten Kosten des erstinstanzlichen Verfahrens, die mit 1.776,05 EUR (darin enthalten 296,01 EUR USt) bestimmten Kosten des Berufungsverfahrens und des Kostenrekurses sowie die mit 1.475,42 EUR (darin enthalten 114,82 EUR USt und 786,50 EUR Barauslagen) bestimmten Kosten des Revisionsverfahrens zu ersetzen.
...
- `EUR USt` — no gold match — likely missing annotation
- `EUR USt` — no gold match — likely missing annotation
- `EUR Barauslagen` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 4

**Example 17** (doc_id: `deanon_TRAIN/10Ob15_16b`) (sent_id: `deanon_TRAIN/10Ob15_16b_29`)


Das Kind hat im Wesentlichen bloß zu behaupten, dass die Voraussetzungen, die bei der Erstgewährung angenommen wurden, weiterhin gegeben sind (10 Ob 67/11t;NeumayrinSchwimann/Kodek, ABGB4§ 18 UVG Rz 1 mwN).

**False Positives:**

- `UVG Rz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 18** (doc_id: `deanon_TRAIN/10Ob15_16b`) (sent_id: `deanon_TRAIN/10Ob15_16b_35`)
...
**Example 19** (doc_id: `deanon_TRAIN/10Ob15_16b`) (sent_id: `deanon_TRAIN/10Ob15_16b_36`)


Diese Grundsätze gelten jedenfalls auch im Fall der Weitergewährung, wo das Kind im Wesentlichen nur zu behaupten hat, dass die Voraussetzungen, die bei der Erstgewährung angenommen wurden, insbesondere der Versuch einer Titelschaffung, weiterhin gegeben sind (10 Ob 67/11t;NeumayrinSchwimann/Kodek, ABGB4§ 18 UVG Rz 1, 4 und 5).
...
**Example 20** (doc_id: `deanon_TRAIN/10Ob16_16z`) (sent_id: `deanon_TRAIN/10Ob16_16z_17`)


Nach der Rechtsprechung stelle auch die prekaristische Überlassung einer Wohnung eine Weitergabe dar (8 Ob 541/91 mwH;Würth/Zingher/Kovanyi, Miet- und Wohnrecht I23§ 30 MRG Rz 32 mwH) und auch diese könne vom Mieter jederzeit widerrufen werden.

**False Positives:**

- `MRG Rz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 21** (doc_id: `deanon_TRAIN/10Ob18_25g`) (sent_id: `deanon_TRAIN/10Ob18_25g_3`)
...
**Example 22** (doc_id: `deanon_TRAIN/10Ob18_25g`) (sent_id: `deanon_TRAIN/10Ob18_25g_25`)


Das Recht von MUN Analyse Solutions gemäß Punkt XXVI.

**False Positives:**

- `MUN Analyse` — partial — pred is substring of gold: `MUN Analyse Solutions`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `MUN Analyse Solutions`(organisation)

**Example 23** (doc_id: `deanon_TRAIN/10Ob19_25d`) (sent_id: `deanon_TRAIN/10Ob19_25d_3`)
...
- `BEURLE Rechtsanwälte` — no gold match — likely missing annotation
...
**Example 24** (doc_id: `deanon_TRAIN/10Ob19_25d`) (sent_id: `deanon_TRAIN/10Ob19_25d_14`)


Zudem wurde festgehalten, dass der Kunde in Verbindung mit einer 12-monatigen Mindestvertragslaufzeit eine 12-monatige Preisgarantie und die Mitgliedschaft im Georgette Klingenmayer, BA LLM -Club erhält.

**False Positives:**

- `BA LLM` — partial — pred is substring of gold: `Georgette Klingenmayer, BA LLM`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `Georgette Klingenmayer, BA LLM`(person)

**Example 25** (doc_id: `deanon_TRAIN/10Ob20_19t`) (sent_id: `deanon_TRAIN/10Ob20_19t_4`)


Pia Hörnel und 2. Cathleen Faßl, beide vertreten durch Dr. Zsizsik & Dr. Prattes Rechtsanwälte OG in Bruck an der Mur, gegen die beklagte Partei DI Frauke Brückner, vertreten durch Dr. Manfred Steininger, Rechtsanwalt in Wien, wegen 100.422,20 EUR sA, über die außerordentliche Revision der klagenden Parteien gegen das Urteil des Oberlandesgerichts Graz als Berufungsgericht vom 8. Jänner 2019, GZ 2 R 189/18h-14, mit dem das Urteil des Landesgerichts Leoben vom 12. April 2018, GZ 4 Cg 6/18s-10, bestätigt wurde, den Beschluss gefasst:  Spruch Der außerordentlichen Revision wird Folge gegeben.

**False Positives:**

- `DI Frauke` — partial — pred is substring of gold: `DI Frauke Brückner`
...
- `Pia Hörnel`(person)
- `Cathleen Faßl`(person)
- `DI Frauke Brückner`(person)

**Example 26** (doc_id: `deanon_TRAIN/10Ob20_19t`) (sent_id: `deanon_TRAIN/10Ob20_19t_62`)


Die herrschende Ansicht verneint im Allgemeinen eine Verpflichtung zur Einholung eines Privatgutachtens (M. BydlinskiinRummel³ § 1489 ABGB Rz 3;Dehnin KBB5§ 1489 ABGB Rz 3 jeweils mwN;

**False Positives:**

- `ABGB Rz` — no gold match — likely missing annotation
- `ABGB Rz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 2

**Example 27** (doc_id: `deanon_TRAIN/10Ob22_22s`) (sent_id: `deanon_TRAIN/10Ob22_22s_4`)
...
**Example 28** (doc_id: `deanon_TRAIN/10Ob23_14a`) (sent_id: `deanon_TRAIN/10Ob23_14a_44`)


Eine Aliquotierung für Bruchteile von Monaten ist dem UVG fremd (NeumayrinSchwimann/Kodek, ABGB4§ 8 UVG Rz 3 mwN).
...
**Example 29** (doc_id: `deanon_TRAIN/10Ob23_14a`) (sent_id: `deanon_TRAIN/10Ob23_14a_57`)


5. Auch eine Einstellung der Vorschüsse wegen Eigeneinkommens hat daher erst mit Ablauf desjenigen Monats zu erfolgen, in dem die erste Lohnauszahlung erfolgt (vglNeumayrinSchwimann/Kodek, ABGB4§ 20 UVG Rz 16 mwN;Gitschthalerin seiner Entscheidungsbesprechung in EF-Z 2014/51, 82).
...
**Example 30** (doc_id: `deanon_TRAIN/10Ob23_15b`) (sent_id: `deanon_TRAIN/10Ob23_15b_3`)
...
- `BA MBA` — partial — pred is substring of gold: `Bruno Altevogt, BA MBA`
...
**Example 31** (doc_id: `deanon_TRAIN/10Ob26_14t`) (sent_id: `deanon_TRAIN/10Ob26_14t_8`)
...
**Example 32** (doc_id: `deanon_TRAIN/10Ob26_14t`) (sent_id: `deanon_TRAIN/10Ob26_14t_13`)
...
**Example 33** (doc_id: `deanon_TRAIN/10Ob26_14t`) (sent_id: `deanon_TRAIN/10Ob26_14t_39`)


Er äußerte dabei, mit OSR Thomas Jöne „nicht mehr arbeiten zu können und zu wollen“.

**False Positives:**

- `OSR Thomas` — partial — pred is substring of gold: `OSR Thomas Jöne`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `OSR Thomas Jöne`(person)

**Example 34** (doc_id: `deanon_TRAIN/10Ob26_14t`) (sent_id: `deanon_TRAIN/10Ob26_14t_94`)


Es ist darauf abzustellen, ob der Erklärungsempfänger einen rechtsgeschäftlichen Willen erschließen durfte und erschlossen hat (RIS-Justiz RS0014158 [T7];Bollenbergerin KBB4§ 863 ABGB Rz 3 mwN; vgl RIS-Justiz RS0113932).
...
**Example 35** (doc_id: `deanon_TRAIN/10Ob2_10g`) (sent_id: `deanon_TRAIN/10Ob2_10g_30`)


besteht in diesem Verfahren kein Anwaltszwang, müssen schriftliche Rekurse nicht mit der Unterschrift eines Rechtsanwalts versehen sein (vgl Zechner in Fasching/Konecny2 § 520 ZPO Rz 23).
...
**Example 36** (doc_id: `deanon_TRAIN/10Ob2_10g`) (sent_id: `deanon_TRAIN/10Ob2_10g_34`)


Im Außerstreitverfahren besteht im Rekursverfahren nur eine relative Vertretungspflicht (vgl § 6 AußStrG), sodass der vorliegende Rekurs nicht der anwaltlichen Unterfertigung bedurfte (vgl Zechner aaO § 520 ZPO Rz 18).
...
**Example 38** (doc_id: `deanon_TRAIN/10Ob2_22z`) (sent_id: `deanon_TRAIN/10Ob2_22z_4`)
...
**Example 39** (doc_id: `deanon_TRAIN/10Ob30_19p`) (sent_id: `deanon_TRAIN/10Ob30_19p_20`)


DasErstgerichtgewährte nach §§ 3, 4 Z 1 UVG Titelvorschüsse von 300 EUR für den Zeitraum 1.

**False Positives:**

- `UVG Titelvorschüsse` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 40** (doc_id: `deanon_TRAIN/10Ob30_19p`) (sent_id: `deanon_TRAIN/10Ob30_19p_34`)


RIS-Justiz RS0076391 [T15];NeumayrinSchwimann/KodekI4§ 7 UVG Rz 1), um eine Belastung des Staats mit zu hohen, offensichtlich nicht der gesetzlichen Unterhaltspflicht entsprechenden Unterhaltsvorschüssen zu verhindern (10 Ob 24/17b mwN).
...
**Example 41** (doc_id: `deanon_TRAIN/10Ob31_16f`) (sent_id: `deanon_TRAIN/10Ob31_16f_3`)
...
**Example 42** (doc_id: `deanon_TRAIN/10Ob31_16f`) (sent_id: `deanon_TRAIN/10Ob31_16f_7`)
...
- `EUR Umsatzsteuer` — no gold match — likely missing annotation
- `EUR Barauslagen` — no gold match — likely missing annotation
- `EUR Umsatzsteuer` — no gold match — likely missing annotation
- `EUR Umsatzsteuer` — no gold match — likely missing annotation
...
**Example 43** (doc_id: `deanon_TRAIN/10Ob33_15y`) (sent_id: `deanon_TRAIN/10Ob33_15y_4`)
...
**Example 44** (doc_id: `deanon_TRAIN/10Ob33_15y`) (sent_id: `deanon_TRAIN/10Ob33_15y_72`)


Ein Teilurteil erfüllt in dem erledigten Umfang vielmehr die Funktion eines Endurteils (OLG Wien, 14 R 9/96, WR 762 [1996]).

**False Positives:**

- `OLG Wien` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 45** (doc_id: `deanon_TRAIN/10Ob38_25y`) (sent_id: `deanon_TRAIN/10Ob38_25y_3`)
...
**Example 46** (doc_id: `deanon_TRAIN/10Ob41_14y`) (sent_id: `deanon_TRAIN/10Ob41_14y_3`)
...
- `DI Dr` — positional overlap with gold: `Dr. Jakob Krägeloh`
...
**Example 47** (doc_id: `deanon_TRAIN/10Ob41_20g`) (sent_id: `deanon_TRAIN/10Ob41_20g_6`)
...
**Example 48** (doc_id: `deanon_TRAIN/10Ob42_15x`) (sent_id: `deanon_TRAIN/10Ob42_15x_59`)


Im Hinblick auf die Dispositionsfreiheit des Antragstellers ist das Gericht weder berechtigt, höhere als die begehrten Vorschüsse zuzusprechen, noch einen anderen Vorschussgrund als beantragt für den Zuspruch heranzuziehen (NeumayrinSchwimann/Kodek, ABGB4§ 11 UVG Rz 2 mwN).
...
**Example 49** (doc_id: `deanon_TRAIN/10Ob42_15x`) (sent_id: `deanon_TRAIN/10Ob42_15x_64`)


In diesem Fall ist dem Antrag ausnahmsweise nicht stattzugeben und sind die Vorschüsse nach § 7 Abs 1 Z 1 UVG von vornherein zu versagen (NeumayrinSchwimann/Kodek, ABGB4§ 7 UVG Rz 4, 33).
...
**Example 50** (doc_id: `deanon_TRAIN/10Ob42_15x`) (sent_id: `deanon_TRAIN/10Ob42_15x_75`)


6.1 Zum Vorbringen im Revisionsrekurs, die Vorgangsweise des Rekursgerichts stelle „in Wahrheit“ die amtswegige Wahrnehmung eines Einstellungsgrundes zu Gunsten des die Entscheidung insoweit nicht bekämpfenden Bundes dar, ist noch Folgendes klarzustellen: 6.2 Wird ein Versagungsgrund nach Rechtskraft des Gewährungsbeschlusses während laufender Vorschüsse bekannt, ist ein Verfahren nach den §§ 19, 20 UVG (Änderung bzw Einstellung der Vorschüsse) einzuleiten (NeumayrinSchwimann/Kodek, ABGB4§ 7 UVG Rz 37).
...
**Example 51** (doc_id: `deanon_TRAIN/10Ob58_25i`) (sent_id: `deanon_TRAIN/10Ob58_25i_3`)


Kopf Der Oberste Gerichtshof hat durch den Senatspräsidenten Dr. Hargassner als Vorsitzenden, den Vizepräsidenten Hon.-Prof. PD Dr. Rassi, die Hofräte Dr. Annerl und Dr. Vollmaier sowie die Hofrätin Dr. Wallner-Friedl in der Pflegschaftssache der Minderjährigen 1.
...
**Example 52** (doc_id: `deanon_TRAIN/10Ob64_19p`) (sent_id: `deanon_TRAIN/10Ob64_19p_4`)
...
**Example 53** (doc_id: `deanon_TRAIN/10Ob64_19p`) (sent_id: `deanon_TRAIN/10Ob64_19p_5`)
...
- `EUR Agio` — no gold match — likely missing annotation
...
**Example 54** (doc_id: `deanon_TRAIN/10Ob69_19y`) (sent_id: `deanon_TRAIN/10Ob69_19y_3`)
...
- `DI Daniel` — partial — pred is substring of gold: `DI Daniel Wiegand`
...
**Example 55** (doc_id: `deanon_TRAIN/10Ob69_19y`) (sent_id: `deanon_TRAIN/10Ob69_19y_4`)
...
**Example 56** (doc_id: `deanon_TRAIN/10Ob69_19y`) (sent_id: `deanon_TRAIN/10Ob69_19y_5`)
...
**Example 57** (doc_id: `deanon_TRAIN/10Ob88_19t`) (sent_id: `deanon_TRAIN/10Ob88_19t_4`)
...
**Example 58** (doc_id: `deanon_TRAIN/10ObS21_10a`) (sent_id: `deanon_TRAIN/10ObS21_10a_54`)


1.2 Die nach ASVG Versicherten erhalten die Krankenbehandlung grundsätzlich als Sachleistung.

**False Positives:**

- `ASVG Versicherten` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 59** (doc_id: `deanon_TRAIN/10ObS21_10a`) (sent_id: `deanon_TRAIN/10ObS21_10a_99`)


Da die Übereinstimmung zwischen dem vertraglich begründeten Leistungsanspruch und dem gesetzlich determinierten Anspruch gegen die Sozialversicherung erst ex post geprüft wird, birgt das Kostenerstattungsmodell für die Versicherten erhebliche Unsicherheiten (vglSchrammel, Die Durchsetzung von Leistungsansprüchen in der sozialen Krankenversicherung, in FS Tomandl [1998] 679 ff [681]).

**False Positives:**

- `FS Tomandl` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 60** (doc_id: `deanon_TRAIN/10ObS7_10t`) (sent_id: `deanon_TRAIN/10ObS7_10t_3`)
...
- `KR Mag` — no gold match — likely missing annotation
...
**Example 61** (doc_id: `deanon_TRAIN/11Ns22_17z`) (sent_id: `deanon_TRAIN/11Ns22_17z_11`)
...
**Example 62** (doc_id: `deanon_TRAIN/11Ns22_17z`) (sent_id: `deanon_TRAIN/11Ns22_17z_12`)
...
- `BG Steyr` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 63** (doc_id: `deanon_TRAIN/11Os113_12w`) (sent_id: `deanon_TRAIN/11Os113_12w_6`)
...
- `DKZ Solar` — partial — pred is substring of gold: `DKZ Solar GesmbH`
...
**Example 64** (doc_id: `deanon_TRAIN/11Os59_13f`) (sent_id: `deanon_TRAIN/11Os59_13f_11`)


SSt 53/22;Eder-Riederin WK2§ 143 Rz 18;Kienapfel/Schmoller,StudB BT II § 143 Rz 13 ff).

**False Positives:**

- `BT II` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 65** (doc_id: `deanon_TRAIN/12Os34_19w`) (sent_id: `deanon_TRAIN/12Os34_19w_7`)


ZP EMRK sowie Art 17, 47 und 48 GRC“ geltend macht.

**False Positives:**

- `ZP EMRK` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 66** (doc_id: `deanon_TRAIN/13Os37_12h`) (sent_id: `deanon_TRAIN/13Os37_12h_3`)
...
- `DI Georg` — no gold match — likely missing annotation
...
**Example 67** (doc_id: `deanon_TRAIN/13Os37_12h`) (sent_id: `deanon_TRAIN/13Os37_12h_4`)


Gründe:  Rechtliche Beurteilung Mit dem angefochtenen Beschluss wies das Oberlandesgericht Innsbruck die Beschwerden der Anna Wegnast und des DI Georg Lu Noel Fraczek gegen den Beschluss des Landesgerichts Innsbruck vom 12. August 2011, mit dem deren Antrag auf Fortführung des Ermittlungsverfahrens abgewiesen worden war, gemäß § 196 Abs 3 zweiter Satz StPO als unzulässig zurück.
...
**Example 68** (doc_id: `deanon_TRAIN/13Os37_12h`) (sent_id: `deanon_TRAIN/13Os37_12h_5`)


Mit den dagegen erhobenen Beschwerden (von DI Lu Eckard Hildbrandt ergänzt mit Schriftsatz vom 15. April 2012) war ebenso zu verfahren, weil die Strafprozessordnung gegen solche Entscheidungen keinen Rechtszug vorsieht.

**False Positives:**

- `DI Lu` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Gold Entities:**

- `Eckard Hildbrandt`(person)

**Example 69** (doc_id: `deanon_TRAIN/13Os78_12p`) (sent_id: `deanon_TRAIN/13Os78_12p_3`)
...
**Example 70** (doc_id: `deanon_TRAIN/13Os78_12p`) (sent_id: `deanon_TRAIN/13Os78_12p_4`)


Gründe:  Rechtliche Beurteilung Mit dem angefochtenen Beschluss wies das Oberlandesgericht Innsbruck die Beschwerden der Anna Witschak und des DI Georg Lu Wendelin Zakrevskiy gegen mehrere Verfügungen des Vorsitzenden eines Drei-Richter-Senats des Landesgerichts Innsbruck als unzulässig zurück.
...
**Example 71** (doc_id: `deanon_TRAIN/13Os99_19m`) (sent_id: `deanon_TRAIN/13Os99_19m_10`)


Eine – auf bestimmte Arten des erstgerichtlichen Ausspruchs (etwa teilweise oder vollständige Verweisung auf den Zivilrechtsweg) bezogene – Einschränkung dieses Berufungsrechts ist dem Gesetz, das in § 464 Z 3 StPO (im auffallenden Gegensatz zu Z 2) keinen Verweis auf § 283 StPO enthält (vgl auch § 489 Abs 1 StPO), nicht zu entnehmen (Ratz, WK-StPO § 464 Rz 7;Spenling, WK-StPO § 366 Rz 22;Fabrizy, StPO13§ 465 Rz 2;Nimmervoll, Das Strafverfahren2Kap VI Rz 275; vgl [zur früheren Rechtslage] RIS-Justiz RS0101318, [zum schöffengerichtlichen Verfahren] RS0109956).

**False Positives:**

- `VI Rz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 72** (doc_id: `deanon_TRAIN/14Ns25_17p`) (sent_id: `deanon_TRAIN/14Ns25_17p_12`)


Entgegen der Ansicht des Bezirksgerichts Wiener Neustadt ändert daran auch nichts, dass Geldschulden nach § 907a ABGB Bringschulden sind.

**False Positives:**

- `ABGB Bringschulden` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 73** (doc_id: `deanon_TRAIN/14Os121_19d`) (sent_id: `deanon_TRAIN/14Os121_19d_10`)


Der Verfahrensrüge (Z 4) zuwider wurden durch die Abweisung des Antrags auf „Durchführung eines Lokalaugenscheins und einer Tatrekonstruktion zum Beweis dafür, dass aufgrund der örtlichen Gegebenheiten die Schilderungen der Zeugen HR Thilo Tiedicke und Zlatan Rossmann, insbesondere mit dem angeblichen Zufahren auf die Zeugen, aufgrund der gegebenen Örtlichkeiten nicht der Wahrheit entsprechen können“ (ON 15 S 100), Verteidigungsrechte des Beschwerdeführers nicht verletzt.

**False Positives:**

- `HR Thilo` — partial — pred is substring of gold: `HR Thilo Tiedicke`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `HR Thilo Tiedicke`(person)
- `Zlatan Rossmann`(person)

**Example 74** (doc_id: `deanon_TRAIN/14Os16_15g`) (sent_id: `deanon_TRAIN/14Os16_15g_11`)


Vorliegend wurde die im Beweisantrag thematisierte Videoaufzeichnung der inkriminierten Tathandlung (Videoaufzeichnung der CD Kärnten 1), die dem Sachverständigen (eigenen Angaben zufolge;

**False Positives:**

- `CD Kärnten` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 75** (doc_id: `deanon_TRAIN/14Os19_16z`) (sent_id: `deanon_TRAIN/14Os19_16z_6`)
...
- `HR Dr` — partial — pred is substring of gold: `StR HR Dr.in Danielle Besmer`
...
**Example 76** (doc_id: `deanon_TRAIN/15Os161_11g`) (sent_id: `deanon_TRAIN/15Os161_11g_26`)


Ob die Täter jedoch beim Einfahren in die Garage eine - einem Schlüssel im Sinn der zitierten Gesetzesstelle entsprechenden (vglLeukauf/SteiningerKomm3§ 129 RN 18;Kienapfel/SchmollerStudienbuch BT II § 129 RN 36;Höpfel, ÖJZ 1983, 235;Kienapfel, JBl 1986, 264) - Fernbedienung zur Öffnung der Sperrvorrichtung des Garagentors verwendeten, ist der Aussage dieses Zeugen gerade nicht zu entnehmen.
...
**Example 77** (doc_id: `deanon_TRAIN/15Os24_24d_15Os25_24a_`) (sent_id: `deanon_TRAIN/15Os24_24d_15Os25_24a__6`)


Text Gründe: [1] In der Straf- und Medienrechtssache des Privatanklägers und Antragstellers Bertha Beyfus gegen die Angeklagte und Antragsgegnerin OSR Roberta Hitzmann, AZ 5 Hv 9/22y des Landesgerichts für Strafsachen Graz, wurde – soweit hier von Bedeutung – die Angeklagte mit Urteil dieses Gerichts vom 8. April 2022, GZ 5 Hv 9/22y-7, gemäß § 259 Z 3 StPO vom – in der Privatanklage als Vergehen der üblen Nachrede nach § 111 Abs 1 und 2 StGB und der Beleidigung nach § 115 Abs 1 StGB subsumierten – Vorwurf freigesprochen, sie habe (zusammengefasst) in Osthang 8, 8843 Peterdorf, Österreich von 22. Februar bis Anfang September 2021 fünf näher genannte, auf den Privatankläger bezogene, diesen eines unehrenhaften und gegen die guten Sitten verstoßenden Verhaltens beschuldigende und ihn beleidigende Kommentare anderer Nutzer nicht unverzüglich gelöscht, die diese auf ihrem öffentlich einsehbaren Facebook-Profil zu einem von ihr zuvor geteilten Posting verfasst hatten, das aus einem Bild des uniformierten Polizeibeamten Bezirksinspektor Finn Pierskalla mit dem Begleittext bestand „Lasst dieses Gesicht des Polizisten um die Welt gehen.

**False Positives:**

- `OSR Roberta` — partial — pred is substring of gold: `OSR Roberta Hitzmann`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `Bertha Beyfus`(person)
- `OSR Roberta Hitzmann`(person)
- `Osthang 8, 8843 Peterdorf, Österreich`(address)
- `Finn Pierskalla`(person)

**Example 78** (doc_id: `deanon_TRAIN/17Ob17_10i`) (sent_id: `deanon_TRAIN/17Ob17_10i_3`)
...
**Example 79** (doc_id: `deanon_TRAIN/18OCg12_19t`) (sent_id: `deanon_TRAIN/18OCg12_19t_3`)
...
- `SRG Stock` — no gold match — likely missing annotation
...
**Example 80** (doc_id: `deanon_TRAIN/18OCg12_19t`) (sent_id: `deanon_TRAIN/18OCg12_19t_4`)


Text Begründung: Die Klägerin begehrt die Aufhebung des in einem vor dem International Court of Arbitration of the International Chamber of Commerce geführten Schiedsverfahren (ICC Fall Nr 22948/FS) ergangenen Endschiedsspruchs zur Kostenentscheidung vom 28.

**False Positives:**

- `ICC Fall` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 81** (doc_id: `deanon_TRAIN/18OCg12_19t`) (sent_id: `deanon_TRAIN/18OCg12_19t_16`)


RS0110125;HausmaningerinFasching/Konecny³ IV/2 § 611 ZPO Rz 160).
...
**Example 82** (doc_id: `deanon_TRAIN/18OCg12_19t`) (sent_id: `deanon_TRAIN/18OCg12_19t_32`)


Eine entsprechende Vereinbarung kann in der Schiedsvereinbarung (unmittelbar oder durch Verweis auf institutionelle Schiedsregeln) oder in einer getrennten Verfahrensvereinbarung getroffen werden (HausmaningerinFasching/Konecny³ § 609 ZPO Rz 174).
...
**Example 83** (doc_id: `deanon_TRAIN/18OCg12_19t`) (sent_id: `deanon_TRAIN/18OCg12_19t_34`)


Art 38.5 ICC gestattet den Schiedsrichtern in der Kostenentscheidung demnach grundsätzlich Entscheidungsfreiheit, etwa können ICC-Schiedsrichter von jeder Orientierung am Ausgang des Falls Abstand nehmen und innerhalb der Grenzen der Sittenwidrigkeit auch gänzlich andere Ansätze verfolgen (HausmaningerinFasching/Konecny³ § 609 ZPO Rz 18 f mwN).
...
**Example 84** (doc_id: `deanon_TRAIN/1Nc1_15k`) (sent_id: `deanon_TRAIN/1Nc1_15k_24`)


Gerade wenn es um strittige Tatfragen geht, die sich auf zahlreiche Sachverhaltsdetails erstrecken, kommt der unmittelbaren Beweisaufnahme vor dem erkennenden Richter besondere Bedeutung zu, die durch Vernehmungen im Wege von Videokonferenzen oft nur unzureichend nachgebildet werden kann (vgl auchRechbergerinRechberger4§ 277 ZPO Rz 2).
...
**Example 85** (doc_id: `deanon_TRAIN/1Ob106_20z`) (sent_id: `deanon_TRAIN/1Ob106_20z_3`)
...
- `IGK Bau` — partial — pred is substring of gold: `IGK Bau Consulting AG`
- `DI Roxana` — partial — pred is substring of gold: `DI Roxana Pöll`
...
**Example 86** (doc_id: `deanon_TRAIN/1Ob127_14d`) (sent_id: `deanon_TRAIN/1Ob127_14d_7`)


OLG Graz 6 Nc 4/12g, 7 R 4/13g, 7 R 5/13d, 7 R 18/13s, 7 R 29/13h ua; 1 Ob 206/12v;

**False Positives:**

- `OLG Graz` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 87** (doc_id: `deanon_TRAIN/1Ob128_17f`) (sent_id: `deanon_TRAIN/1Ob128_17f_4`)
...
**Example 88** (doc_id: `deanon_TRAIN/1Ob143_17m`) (sent_id: `deanon_TRAIN/1Ob143_17m_3`)


Kopf Der Oberste Gerichtshof hat durch den Senatspräsidenten Hon.-Prof. Dr. Sailer als Vorsitzenden sowie durch die Hofräte Univ.-Prof. Dr. Bydlinski, Mag. Wurzer, Mag. Dr. Wurdinger und die Hofrätin Dr. Hofer-Zeni-Rennhofer als weitere Richter in der Familienrechtssache der Antragstellerin Theodora Simonsohn, vertreten durch die Brandstetter, Baurecht, Pritz & Partner Rechtsanwälte KG, Wien, gegen den Antragsgegner DI Janosch Emmerth, Kasachstan (nähere Anschrift unbekannt), vertreten durch Mag. Thomas Pfaller, Rechtsanwalt in Wien, wegen nachehelicher Vermögensaufteilung, über den außerordentlichen Revisionsrekurs der Antragstellerin gegen den Beschluss des Landesgerichts für Zivilrechtssachen Wien als Rekursgericht vom 30. Mai 2017, GZ 48 R 249/16x-212, mit dem der Beschluss des Bezirksgerichts Hernals vom 30. August 2016, GZ 2 C 446/07f-204, bestätigt wurde, in nichtöffentlicher Sitzung den Beschluss gefasst:  Spruch Der außerordentliche Revisionsrekurs wird mangels der Voraussetzungen des § 62 Abs 1 AußStrG zurückgewiesen.

**False Positives:**

- `DI Janosch` — partial — pred is substring of gold: `DI Janosch Emmerth`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `Theodora Simonsohn`(person)
- `DI Janosch Emmerth`(person)

**Example 89** (doc_id: `deanon_TRAIN/1Ob152_24w`) (sent_id: `deanon_TRAIN/1Ob152_24w_3`)
...
- `GRAF ISOLA` — no gold match — likely missing annotation
...
**Example 90** (doc_id: `deanon_TRAIN/1Ob177_24x`) (sent_id: `deanon_TRAIN/1Ob177_24x_3`)
...
- `DSC Doralt` — no gold match — likely missing annotation
...
**Example 91** (doc_id: `deanon_TRAIN/1Ob177_24x`) (sent_id: `deanon_TRAIN/1Ob177_24x_6`)
...
**Example 92** (doc_id: `deanon_TRAIN/1Ob177_24x`) (sent_id: `deanon_TRAIN/1Ob177_24x_115`)
...
- `DFA Planung` — partial — pred is substring of gold: `DFA Planung AG`
...
**Example 93** (doc_id: `deanon_TRAIN/1Ob178_19m`) (sent_id: `deanon_TRAIN/1Ob178_19m_88`)


3 Ob 170/19z;G. KodekinFasching/Konecny³II/2 §§ 84, 85 ZPO Rz 185/1 mwH).
...
**Example 94** (doc_id: `deanon_TRAIN/1Ob178_19m`) (sent_id: `deanon_TRAIN/1Ob178_19m_89`)


Die Klage ist dann im Vorprüfungsverfahren gemäß § 538 ZPO mit Beschluss zurückzuweisen (RS0044558 [T6, T14];JelinekinFasching/Konecny² IV/1 § 530 ZPO Rz 220).
...
**Example 95** (doc_id: `deanon_TRAIN/1Ob184_15p`) (sent_id: `deanon_TRAIN/1Ob184_15p_4`)
...
**Example 96** (doc_id: `deanon_TRAIN/1Ob184_15p`) (sent_id: `deanon_TRAIN/1Ob184_15p_45`)


Auf diesen Rechtsgrund kann er schon deshalb im Revisionsverfahren nicht mehr zurückkommen (vgl nur die Judikaturnachweise beiKodekinRechberger4§ 503 ZPO Rz 23).
...
**Example 97** (doc_id: `deanon_TRAIN/1Ob184_15p`) (sent_id: `deanon_TRAIN/1Ob184_15p_48`)


Generell ist eine Zinsminderung ausgeschlossen, wenn der Bestandnehmer in Kenntnis einer gewissen Gebrauchsbeeinträchtigung den Bestandvertrag abschließt (vgl nurIroin KBB4§ 1096 ABGB Rz 11 unter Hinweis auf RIS-Justiz RS0021408).
