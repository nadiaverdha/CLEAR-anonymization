...
Generated on: 2026-05-24T15:31:05.034479
...
| Best Batch Idx | 0 |
| Best Batch F1 | 0.32948929159802304 |
...
| `Name_Following_Betreff` | 0.0% | 0.0% | 0.0% | 2 | 0 | 2 |
| `Name_In_Parentheses` | 0.0% | 0.0% | 0.0% | 5 | 0 | 5 |
...
**Example 0** (doc_id: `findok-manually-annotated_TRAIN/132828.1`) (sent_id: `findok-manually-annotated_TRAIN/132828.1_12`)


Die mit „Znojmo den 30.09.2020“ datierte Beschwerde lautet:  Sozialversicherungsnummer: 4884 090688  Betreff: Beschwerde gegen Ihren Abweisungsbescheid vom 01.09.2020  Gegen Ihren Abweisungsbescheid vom 01.09.2020 erhebe ich innerhalb offener Frist  BESCHWERDE  und begründe dies wie folgt:  Der vorgenommene Kürzung ist rechtswidrig da sie in eklatanter Weise gegen geltendes EU- Recht verstößt.
...
- `4884 090688`(social_security_number)

**Example 1** (doc_id: `findok-manually-annotated_TRAIN/132828.1`) (sent_id: `findok-manually-annotated_TRAIN/132828.1_41`)


Am 23. November 2020 erstellte der Bf. folgenden Vorlageantrag an das Bundesfinanzgericht  (und langte dieser am 24. November 2020 ein; das Bundesfinanzgericht übermittelte den  Vorlageantrag an das Finanzamt, wo er am 27. November 2020 einlangte):  Betreff:  Indexierung der Familienbeihilfe - Ihre Beschwerdevorentscheidung vom 09.11.2020  Antrag auf Entscheidung über die Beschwerde (Vorlageantrag)  Begründung:  [idente Begründung wie in der Beschwerde]

**False Positives:**

- `In` — similar text (different position): `Bundesfinanzgericht`
...
**Example 0** (doc_id: `findok-manually-annotated_TRAIN/144052.1`) (sent_id: `findok-manually-annotated_TRAIN/144052.1_35`)


Des Weiteren wurde ein Antrag auf Durchführung einer mündlichen Verhandlung gestellt  Mit weiterer Eingabe vom 03.08.2022 wurde eine mit 19.07.2022 datierende und von der Bf.  eigenhändig unterfertigte eidesstattliche Erklärung vorgelegt, in der ua ausgeführt wird, wie  folgt: „Ich bewohnte und nutze in der X-Straße das Erdgeschoß (ca. 109 m²) und das  Untergeschoß (ca. 100 m², der Technikraum von ca. 10 m²) abgezogen.“

**False Positives:**

- `ca. 100 m², der Technikraum von ca. 10 m²` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 1** (doc_id: `findok-manually-annotated_TRAIN/144052.1`) (sent_id: `findok-manually-annotated_TRAIN/144052.1_109`)


In der eidesstattlichen Erklärung der Bf. vom 19.07.2022 hingegen ist  plötzlich im Zusammenhang mit den Flächen die Rede von ca. 109 m² im EG und ca. 100 m² im  UG (rücksichtlich eines Abzuges von 10 m² für den Technikraum).

**False Positives:**

- `rücksichtlich eines Abzuges von 10 m² für den Technikraum` — no gold match — likely missing annotation

> overlaps gold: 0  |  likely missing annotation: 1

**Example 2** (doc_id: `findok-manually-annotated_TRAIN/145564.1`) (sent_id: `findok-manually-annotated_TRAIN/145564.1_73`)


(Das  Gutachten von Univ.-Prof. Dr. Ehrke-Rabel wurde als integrierender Bestandteil der  Beschwerde vom 31.05.2013 beigelegt).

**False Positives:**

- `Das  Gutachten von Univ.-Prof. Dr. Ehrke-Rabel wurde als integrierender Bestandteil der  Beschwerde vom 31.05.2013 beigelegt` — partial — gold is substring of pred: `Univ.-Prof. Dr. Ehrke-Rabel`

> overlaps gold: 1  |  likely missing annotation: 0

**Gold Entities:**

- `Univ.-Prof. Dr. Ehrke-Rabel`(person)

**Example 3** (doc_id: `findok-manually-annotated_TRAIN/145564.1`) (sent_id: `findok-manually-annotated_TRAIN/145564.1_98`)
...
- `vgl. Seite 3 der  Beschwerde vom 31.5.2013 inklusive Gutachten von Univ.-Prof. Dr. Tina Ehrke-Rabel, welches  als integrierender Bestandteil der Beschwerde 31.05.2013 anzusehen ist` — partial — gold is substring of pred: `Univ.-Prof. Dr. Tina Ehrke-Rabel`
...
- `BFG`(organisation)
- `Lexdon IT`(organisation)
- `Houdek Maschinenbau`(organisation)
- `Univ.-Prof. Dr. Tina Ehrke-Rabel`(person)

**Example 4** (doc_id: `findok-manually-annotated_TRAIN/149390.1`) (sent_id: `findok-manually-annotated_TRAIN/149390.1_94`)


Diesbezüglich habe ich auch Unterlagen zum  Ergänzungsansuchen 19.07.2023 (Frau Mag. G.) fristgerecht am 30.08.2023 übermittelt.

**False Positives:**

- `Frau Mag. G.` — no gold match — likely missing annotation
