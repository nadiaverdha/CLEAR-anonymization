...
Generated on: 2026-05-21T15:54:55.616831
...
| Metric | Value |
|---|---|
| Accuracy (exact match) | 92.4% |
| True Positives | 27 |
| False Positives | 79 |
| False Negatives | 63 |
| Total Gold Entities | 90 |
| Micro Precision | 25.5% |
| Micro Recall | 30.0% |
| Micro F1 | 27.6% |
| Macro F1 | 27.6% |
...
| `names_after_service_context` | 0.0% | 0.0% | 0.0% | 22 | 0 | 22 |
| `names_after_representative_context` | 0.0% | 0.0% | 0.0% | 2 | 0 | 2 |
| `names_in_parentheses_context` | 0.0% | 0.0% | 0.0% | 0 | 0 | 0 |
...
**Rule ID:** `c84a1196`  
**Description:**
Matches names appearing after specific legal case context phrases, stopping before address indicators or commas, with stricter name validation.
...
**Rule ID:** `cbd996c2`  
**Description:**
Matches names appearing after 'bei der' or 'bei den' (common in legal texts for service of process), e.g., 'bei der Hugo Buring'.

**Content:**
```
(?:bei der|bei den)\s+([A-Z][a-zäöüß]+(?:\s+[A-Z][a-zäöüß]+)*)
```
...
- `Bemessung` — no gold match — likely missing annotation
...
**Rule ID:** `d815e316`  
**Description:**
Matches names preceded by 'Herr' or 'Frau', ensuring the match stops at the end of the name and not at subsequent nouns.

**Content:**
```
(?:Herr|Frau)\s+([A-Z][a-zäöüß]+(?:\s+[A-Z][a-zäöüß]+)*(?:\s+von\s+[A-Z][a-zäöüß]+)?)(?=[,\s\n]|$)
```
...
**Rule ID:** `cf0ffb39`  
**Description:**
Matches names appearing in parentheses after a colon or comma, often used for clarification or role assignment.

**Content:**
```
(?:\(|,\s*)[A-Z][a-zäöüß]+(?:\s+[A-Z][a-zäöüß]+)*(?:\s+von\s+[A-Z][a-zäöüß]+)?(?:\s+\))
```
...
**Example 11** (doc_id: `findok-manually-annotated_VALIDATE/149825.1`) (sent_id: `findok-manually-annotated_VALIDATE/149825.1_93`)
...
**Example 12** (doc_id: `findok-manually-annotated_VALIDATE/149825.1`) (sent_id: `findok-manually-annotated_VALIDATE/149825.1_123`)
...
**Example 13** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_15`)
...
**Example 14** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_28`)
...
**Example 15** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_33`)
...
**Example 16** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_36`)
...
**Example 17** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_37`)
...
**Example 18** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_86`)
...
**Example 19** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_127`)
...
**Example 20** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_144`)
...
**Example 21** (doc_id: `findok-manually-annotated_VALIDATE/149885.1`) (sent_id: `findok-manually-annotated_VALIDATE/149885.1_211`)
...
## `names_after_representative_context`
...
**Rule ID:** `52bbb1a2`  
**Description:**
Matches names appearing after 'vertreten durch' (represented by) to capture lawyers and representatives.

**Content:**
```
vertreten\s+durch\s+([A-Z][a-zäöüß]+(?:\s+[A-Z][a-zäöüß]+)*)
```
