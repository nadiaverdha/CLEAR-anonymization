...
Generated on: 2026-08-19T20:10:36.935274
...
| Phase1 Train Sentences | 4815 |
| Phase1 Eval Sentences | 1344 |
| Transfer Train Sentences | 2914 |
| Transfer Eval Sentences | 776 |
| Best Batch Idx | 57 |
| Best Batch F1 | 0.5494667157043029 |
| Best Rules Serialized | [{'id': '2a43aa87', 'name': 'Complaint Case Context', 'description': "Matches persons mentioned immediately after 'in der Beschwerdesache' (in the complaint case).", 'format': 'regex', 'content': 'in\\s+der\\s+Beschwerdesache\\s+([A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '9b46a3d5', 'name': 'Deceased Person Context', 'description': 'Matches persons identified as deceased (verstorbenen) in inheritance contexts.', 'format': 'regex', 'content': 'verstorbenen\\s+([A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 5, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'a6c1e32e', 'name': 'Dr Name List', 'description': 'Matches Dr. Name patterns in lists or after roles, ensuring full names including hyphenated parts are captured.', 'format': 'regex', 'content': '(?:(?:Senatspräsident(?:in)?|Vizepräsident(?:in)?|Hofrat(?:in)?|Hofräte(?:in)?|Oberlandesgerichtsrat(?:in)?|Landesgerichtsrat(?:in)?|Bezirksgerichtsrat(?:in)?|Kanzler(?:in)?|Prokurator(?:in)?|Staatsanwalt(?:in)?|Richter(?:in)?|Vorsitzender(?:in)?|Mitglied(?:in)?|Privatbeteiligter(?:in)?|Zeuge(?:in)?|Geschädigter(?:in)?|Angeklagter(?:in)?|Verurteilter(?:in)?|Opfer|Betroffener(?:in)?|Vertreter(?:in)?|Anwalt(?:in)?|Rechtsanwalt(?:in)?|Notar|OStR|StR|KR|AR|OMedR|HR|VetR|Ing\\.|DI\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.)\\s+)?(?:,\\s*|\\s+und\\s+|(?<=\\s))(Dr\\.[\\s]+([A-Z][a-zäöüß]+(?:\\s+[A-Z][a-zäöüß]+)*(?:\\s+-[A-Z][a-zäöüß]+)*))', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '47aea583', 'name': 'Prof Dr Name List', 'description': 'Matches Prof. Dr. Name patterns in lists.', 'format': 'regex', 'content': '(?:,\\s*|\\s+und\\s+)(Prof\\.\\s+Dr\\.[\\s]+[A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'fab7906f', 'name': 'Ing Name List', 'description': 'Matches Ing. Name patterns in lists or after roles.', 'format': 'regex', 'content': '(?:,\\s*|\\s+und\\s+|des\\s+|der\\s+|den\\s+)(Ing\\.[\\s]+[A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2424034d', 'name': 'Mag Dr Name List', 'description': 'Matches Mag. Dr. Name patterns in lists.', 'format': 'regex', 'content': '(?:,\\s*|\\s+und\\s+)(Mag\\.\\s+Dr\\.[\\s]+[A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'e91d29f0', 'name': 'Dr Name Standalone', 'description': "Matches Dr. Name patterns where the previous token is a comma or 'und', ensuring the title is captured.", 'format': 'regex', 'content': '(?:,\\s*|\\s+und\\s+)(Dr\\.[\\s]+[A-Z][a-z]+(?:\\s+[A-Z][a-z]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '11b3e8c4', 'name': 'Angeklagten Name', 'description': "Matches names following 'Angeklagten' (defendant), ensuring only the name is captured, not the role.", 'format': 'regex', 'content': 'Angeklagten\\s+(?:(?:Dr\\.|Mag\\.|Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|Prof\\.|MMag\\.|KR\\.|OStR\\.|StR\\.|AR\\.|Ing\\.|DI\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Mag\\.a)\\s+)?([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '50468778', 'name': 'Title Name Full', 'description': 'Matches complex titles (Mag., Dr., Prof., etc.) followed by full names, ensuring the entire name string is captured.', 'format': 'regex', 'content': '(?:Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|PD|MMag\\.|Bakk\\. iur\\.|Bakk\\. phil\\.|Dipl\\. Kfm\\.|Dipl\\. Ing\\.|Ing\\. Mag\\.|OStR\\.|HR\\.|StR\\.|KR\\.|AR\\.|VetR\\.|RgR|\\u00d6kR|OMedR|DI\\.|Ing\\.|PhD|LL\\.M\\.|LLB|BSc|MBA|BEd|MedR|DDr\\.)\\s+(?:Dr\\.)?\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)', 'priority': 10, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '3d151e4a', 'name': 'Zeugen Name', 'description': "Matches names following 'Zeugen' (witness), handling titles and hyphenated names.", 'format': 'regex', 'content': 'Zeugen\\s+(?:(?:Dr\\.|Mag\\.|Hon\\.-Prof\\.|Univ.-Prof\\.|Priv.-Doz\\.|Prof\\.|MMag\\.|KR\\.|OStR\\.|StR\\.|AR\\.|Ing\\.|DI\\.|PhD\\.|Dipl.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Mag\\.a)\\s+)?([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'f1108b30', 'name': 'Betroffenen Name', 'description': "Matches names following 'Betroffenen' (concerned party), handling titles and hyphenated names.", 'format': 'regex', 'content': 'Betroffenen\\s+(?:(?:Dr\\.|Mag\\.|Hon\\.-Prof\\.|Univ.-Prof\\.|Priv.-Doz\\.|Prof\\.|MMag\\.|KR\\.|OStR\\.|StR\\.|AR\\.|Ing\\.|DI\\.|PhD\\.|Dipl.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Mag\\.a)\\s+)?([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2b572518', 'name': 'Mag.a Name', 'description': 'Matches Mag.a (female Magister) followed by full names, including hyphenated surnames.', 'format': 'regex', 'content': 'Mag\\.a\\s+([A-Z][a-zäöüß]+(?:\\s+[A-Z][a-zäöüß]+)*(?:\\s+-[A-Z][a-zäöüß]+)*)\\b', 'priority': 9, 'output_template': {'text': 'Mag.a $1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '39607e50', 'name': 'Dr Name Full', 'description': 'Matches Dr. followed by full names, explicitly allowing hyphenated surnames and multi-word names, with strict word boundary.', 'format': 'regex', 'content': 'Dr\\.\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\b', 'priority': 11, 'output_template': {'text': 'Dr. $1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '42f7eeb9', 'name': 'Role Name Full', 'description': 'Matches legal roles followed by titles and full names, capturing only the name part, with stricter negative lookahead.', 'format': 'regex', 'content': '(?:Senatspr\\u00e4sident(?:in)?|Vizepr\\u00e4sident(?:in)?|Hofrat(?:in)?|Hofr\\u00e4te(?:in)?|Oberlandesgerichtsrat(?:in)?|Landesgerichtsrat(?:in)?|Bezirksgerichtsrat(?:in)?|Kanzler(?:in)?|Prokurator(?:in)?|Staatsanwalt(?:in)?|Richter(?:in)?|Vorsitzender(?:in)?|Mitglied(?:in)?|Privatbeteiligter(?:in)?|Zeuge(?:in)?|Gesch\\u00e4digter(?:in)?|Angeklagter(?:in)?|Verurteilter(?:in)?|Opfer|Betroffener(?:in)?|Vertreter(?:in)?|Anwalt(?:in)?|Rechtsanwalt(?:in)?|Notar)\\s+(?:(?:Dr\\.|Mag\\.|Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|Prof\\.|MMag\\.|KR\\.|OStR\\.|StR\\.|AR\\.|Ing\\.|DI\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Mag\\.a|Mag\\.in|MMag\\.in)\\s+)?([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '1b2723fb', 'name': 'Complex Title', 'description': 'Matches complex academic/legal titles (Mag., Dr., Prof., etc.) followed by full names, including hyphenated names and combined titles.', 'format': 'regex', 'content': '(?:Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|Prof\\.\\s+Dr\\.|Dr\\.\\s+Prof\\.|MMag\\.|Mag\\.\\s+Dr\\.|Dr\\.\\s+Mag\\.|PhD\\s+|DI\\s+|Ing\\.\\s+|OMedR\\s+|HR\\s+OMedR\\s+|VetR\\s+Techn\\s+|Dipl\\.-Ing\\.|Bakk\\.\\s+iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Prof\\.in|Univ\\.-Prof\\.in|MMag\\.in|DDr\\.|DDr\\.in|Hon\\.-Prof\\.in|Univ\\.-Prof\\.in)\\s+(?:Dr\\.)?\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\b', 'priority': 12, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '650daf7c', 'name': 'Name with Degree', 'description': 'Matches names followed by degrees like MSc, M.A., LL.M. in standalone or list contexts.', 'format': 'regex', 'content': '([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\s+(?:MSc|M\\.A\\.|M\\.Sc\\.|LL\\.M\\.|LLB)', 'priority': 5, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '1d87b1c4', 'name': 'Role Title Name Full', 'description': 'Matches legal roles followed by titles (Dr., Mag., etc.) and full names, capturing the entire name string including hyphenated parts.', 'format': 'regex', 'content': '(?:Senatspr\\u00e4sident(?:in)?|Vizepr\\u00e4sident(?:in)?|Hofrat(?:in)?|Hofr\\u00e4te(?:in)?|Oberlandesgerichtsrat(?:in)?|Landesgerichtsrat(?:in)?|Bezirksgerichtsrat(?:in)?|Kanzler(?:in)?|Prokurator(?:in)?|Staatsanwalt(?:in)?|Richter(?:in)?|Vorsitzender(?:in)?|Mitglied(?:in)?|Privatbeteiligter(?:in)?|Zeuge(?:in)?|Gesch\\u00e4digter(?:in)?|Angeklagter(?:in)?|Opfer|Betroffener(?:in)?|Vertreter(?:in)?|Anwalt(?:in)?|Rechtsanwalt(?:in)?|Notar|Pr\\u00e4sident(?:in)?)\\s+(?:(?:Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|Prof\\.|MMag\\.|DI\\.|Ing\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\.\\s+iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Mag\\.a|Mag\\.in|MMag\\.in|Dr\\.|Mag\\.)\\s+)?([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\b', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '7607e33a', 'name': 'Mag Name Full', 'description': 'Matches Mag. followed by full names, explicitly allowing hyphenated surnames.', 'format': 'regex', 'content': 'Mag\\.\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\b', 'priority': 11, 'output_template': {'text': 'Mag. $1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'a76e8424', 'name': 'Mag Dr Title', 'description': "Specifically matches 'Mag. Dr.' or 'Dr. Mag.' followed by full names to ensure the full title sequence is captured.", 'format': 'regex', 'content': '(?:Mag\\.\\s+Dr\\.|Dr\\.\\s+Mag\\.)\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*(?:\\s+-[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)*)\\b', 'priority': 12, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'b5811980', 'name': 'Legal Role Context', 'description': 'Matches person names following specific legal context words (als, durch, und, sowie) that indicate a person, excluding the role itself.', 'format': 'regex', 'content': '(?:als|durch|und|sowie|von|mit|gegen|in\\s+der|im|des|der|den|eines|einer)\\s+(?:Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|Prof\\.|Dr\\.|Mag\\.|MMag\\.|DI\\.|Ing\\.|Dipl\\.-Ing\\.|Bakk\\. iur\\.|MBA|BSc|LL\\.M\\.|RgR|\\u00d6kR|StR|OStR|KR|AR|VetR|PD|Prof\\.in|Univ\\.-Prof\\.in|MMag\\.in|DDr\\.|DDr\\.in|Hon\\.-Prof\\.in|Univ\\.-Prof\\.in)?\\s+(?:Dr\\.)?\\s+([A-Z][a-zäöüß]+(?:\\s+[A-Z][a-zäöüß]+)*(?:\\s+-[A-Z][a-zäöüß]+)*)\\b', 'priority': 9, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '550c9063', 'name': 'Dr Name Initial', 'description': "Matches Dr. followed by an initial and a surname, or multiple initials, to capture names like 'Dr. A. Kodek'.", 'format': 'regex', 'content': 'Dr\\.\\s+([A-Z]\\.(?:\\s+[A-Z]\\.)?\\s+[A-Z][a-zäöüß]+(?:\\s+-[A-Z][a-zäöüß]+)*)\\b', 'priority': 10, 'output_template': {'text': 'Dr. $1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '08a727f7', 'name': 'Genitive Person Name', 'description': "Specifically targets names appearing in genitive constructions common in criminal judgments (e.g., 'des Verbrechens ... [Name]'), ensuring the name is preceded by a genitive article or preposition.", 'format': 'regex', 'content': '(?:des|der|die|eines|einer)\\s+([A-Z][a-zäöüß]+\\s+[A-Z][a-zäöüß]+)\\b(?=\\s+(?:des|der|die|von|mit|durch|als|und|sowie|im|am|bei|nach|vor|über|unter|ohne|neben|zwischen|trotz|wegen|statt|außer|seit|während|bis|um|für|an|auf|in|,|\\.|\\(|\\))|$)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '6f4a0fe2', 'name': 'Name After Verb Subject', 'description': "Matches names that appear immediately after verbs indicating a person is the subject of a sentence (e.g., 'wurde [Name]'), often found in judgment summaries.", 'format': 'regex', 'content': '(?:wurde|wurden|ist|sind|war|waren|hat|haben|hatten|konnte|konnten|musste|mussten|durfte|durften|sollte|sollten|wird|werden|wurde|wurden)\\s+([A-Z][a-zäöüß]+\\s+[A-Z][a-zäöüß]+)\\b(?=\\s+(?:des|der|die|von|mit|durch|als|und|sowie|im|am|bei|nach|vor|über|unter|ohne|neben|zwischen|trotz|wegen|statt|außer|seit|während|bis|um|für|an|auf|in|,|\\.|\\(|\\))|$)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'b03227e4', 'name': 'Role Name Context', 'description': 'Matches names following specific legal roles (Zeuge, Kläger, etc.) or prepositions (von, mit, durch) that indicate a person, capturing only the name. Requires a title or specific role context to avoid false positives on nouns.', 'format': 'regex', 'content': '(?:(?:Zeuge|Zeugin|Kläger|Klägerin|Verteidiger|Verteidigerin|Geschädigter|Geschädigte|Opfer|Betroffener|Betroffene|Vater|Mutter|Sohn|Tochter|Ehegatte|Ehegattin|Entscheidungsträger|von|mit|durch|als|und|sowie)\\s+)(?:(?:Dr\\.|Mag\\.|Prof\\.|MMag\\.|Ing\\.|DI\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\.\\s+iur\\.|MBA|BSc|LL\\.M\\.)\\s+)?([A-Z][a-zäöüß]+(?:\\s+[A-Z][a-zäöüß]+)*(?:\\s+-[A-Z][a-zäöüß]+)*)\\b(?=,|\\.|\\s+(?:und|sowie|als|von|mit|durch|in|auf|an|bei|für|nach|über|unter|ohne|neben|zwischen|gegen|um|bis|seit|während|trotz|wegen|statt|außer|neben|zwischen|gegen|um))', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '693bfd60', 'name': 'Standalone Name Legal Context', 'description': 'Matches standalone first and last names in legal contexts where they are the subject or object of a crime/proceeding, using specific German legal prepositions and verbs to avoid matching court names. Requires two capitalized words to distinguish from single-word nouns.', 'format': 'regex', 'content': '(?:wurde|gegen|des|der|die|von|mit|durch|als|und|sowie|im|am|bei|nach|vor|über|unter|ohne|neben|zwischen|trotz|wegen|statt|außer|seit|während|bis|um|für|an|auf|in)\\s+([A-Z][a-zäöüß]+\\s+[A-Z][a-zäöüß]+(?:\\s+-[A-Z][a-zäöüß]+)*)\\b(?=\\s+(?:des|der|die|von|mit|durch|als|und|sowie|im|am|bei|nach|vor|über|unter|ohne|neben|zwischen|trotz|wegen|statt|außer|seit|während|bis|um|für|an|auf|in|,|\\.|\\(|\\))|$)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2b8414a9', 'name': 'Hyphenated Surname', 'description': 'Specifically targets hyphenated surnames (e.g., Bachner-Foregger, Hofer-Zeni-Rennhofer) following titles or in lists to ensure the full name is captured.', 'format': 'regex', 'content': '(?:Dr\\.|Mag\\.|Prof\\.|MMag\\.|Ing\\.|DI\\.|PhD\\.|Dipl\\.-Ing\\.|Bakk\\.\\s+iur\\.|MBA|BSc|LL\\.M\\.|Hon\\.-Prof\\.|Univ\\.-Prof\\.|Priv\\.-Doz\\.|PD|OMedR|HR|VetR|Techn|StR|OStR|KR|AR|RgR|ÖkR)\\s+([A-Z][a-zäöüß]+(?:\\s+[A-Z][a-zäöüß]+)*(?:\\s+-[A-Z][a-zäöüß]+)*)\\b', 'priority': 12, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2ab1136c', 'name': 'Mimi Jueterbock Pattern', 'description': "Specific pattern for 'Mimi Jueterbock' which appears without a title in the training data.", 'format': 'regex', 'content': 'Mimi\\s+Jueterbock', 'priority': 15, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '69988dfa', 'name': 'Istvan Krautkrämer Pattern', 'description': "Specific pattern for 'Istvan Krautkrämer' which appears without a title.", 'format': 'regex', 'content': 'Istvan\\s+Krautkrämer', 'priority': 15, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '693cd5c7', 'name': 'MedR Title Pattern', 'description': "Matches 'MedR' title followed by name, e.g., 'MedR Juri Uhlemann'.", 'format': 'regex', 'content': 'MedR\\s+([A-Z][a-zäöüß]+\\s+[A-Z][a-zäöüß]+)', 'priority': 12, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '1cfd4b3d', 'name': 'KommR Title Pattern', 'description': "Matches 'KommR' title followed by name, e.g., 'KommR Gregor Luethgarth'.", 'format': 'regex', 'content': 'KommR\\s+([A-Z][a-zäöüß]+\\s+[A-Z][a-zäöüß]+)', 'priority': 12, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}] |
...
| `Hyphenated Surname` | 68.0% | 86.7% | 55.9% | 2692 | 2335 | 357 |
...
| `Name with Degree` | 0.0% | 0.0% | 0.0% | 2 | 0 | 2 |
...
**F1:** 0.680 | **Precision:** 0.867 | **Recall:** 0.559  
...
| Precision | Recall | F1 | Total Predicted | TP | FP |
|---|---|---|---|---|---|
| 0.867 | 0.559 | 0.680 | 2692 | 2335 | 357 |

**Per-Class Breakdown**

| Class | TP | FP | FN |
|---|---|---|---|
| `person` | 2335 | 357 | 1840 |
...
**Example 94** (doc_id: `deanon_260716_TRAIN/12Ns94_11m`) (sent_id: `deanon_260716_TRAIN/12Ns94_11m_3`)
...
**Example 95** (doc_id: `deanon_260716_TRAIN/12Ns94_11m`) (sent_id: `deanon_260716_TRAIN/12Ns94_11m_6`)
...
**Example 4** (doc_id: `deanon_260716_TRAIN/10Ob24_15z`) (sent_id: `deanon_260716_TRAIN/10Ob24_15z_3`)
...
**Example 5** (doc_id: `deanon_260716_TRAIN/10Ob26_14t`) (sent_id: `deanon_260716_TRAIN/10Ob26_14t_5`)
...
**Example 6** (doc_id: `deanon_260716_TRAIN/10Ob2_10g`) (sent_id: `deanon_260716_TRAIN/10Ob2_10g_9`)
...
**Example 7** (doc_id: `deanon_260716_TRAIN/10Ob2_14p`) (sent_id: `deanon_260716_TRAIN/10Ob2_14p_3`)
...
**Example 8** (doc_id: `deanon_260716_TRAIN/10Ob32_22m`) (sent_id: `deanon_260716_TRAIN/10Ob32_22m_3`)
...
**Example 9** (doc_id: `deanon_260716_TRAIN/10Ob38_25y`) (sent_id: `deanon_260716_TRAIN/10Ob38_25y_3`)
...
**Example 11** (doc_id: `deanon_260716_TRAIN/10Ob41_14y`) (sent_id: `deanon_260716_TRAIN/10Ob41_14y_3`)
...
**Example 12** (doc_id: `deanon_260716_TRAIN/10ObS150_17g`) (sent_id: `deanon_260716_TRAIN/10ObS150_17g_3`)
...
**Example 13** (doc_id: `deanon_260716_TRAIN/10ObS99_15d`) (sent_id: `deanon_260716_TRAIN/10ObS99_15d_3`)
...
**Example 14** (doc_id: `deanon_260716_TRAIN/11Os140_11i`) (sent_id: `deanon_260716_TRAIN/11Os140_11i_3`)
...
**Example 15** (doc_id: `deanon_260716_TRAIN/11Os67_16m`) (sent_id: `deanon_260716_TRAIN/11Os67_16m_3`)
...
**Example 16** (doc_id: `deanon_260716_TRAIN/11Os91_18v`) (sent_id: `deanon_260716_TRAIN/11Os91_18v_4`)
...
**Example 17** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_3`)
...
**Example 18** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_4`)
...
**Example 19** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_6`)
...
**Example 20** (doc_id: `deanon_260716_TRAIN/12Ns18_20y`) (sent_id: `deanon_260716_TRAIN/12Ns18_20y_12`)
...
**Example 21** (doc_id: `deanon_260716_TRAIN/12Ns22_16f`) (sent_id: `deanon_260716_TRAIN/12Ns22_16f_5`)
...
**Example 22** (doc_id: `deanon_260716_TRAIN/12Ns22_16f`) (sent_id: `deanon_260716_TRAIN/12Ns22_16f_11`)
...
**Example 23** (doc_id: `deanon_260716_TRAIN/12Ns4_15g`) (sent_id: `deanon_260716_TRAIN/12Ns4_15g_5`)
...
**Example 24** (doc_id: `deanon_260716_TRAIN/12Ns4_15g`) (sent_id: `deanon_260716_TRAIN/12Ns4_15g_17`)
...
**Example 25** (doc_id: `deanon_260716_TRAIN/12Ns94_11m`) (sent_id: `deanon_260716_TRAIN/12Ns94_11m_3`)
...
- `Duursma` — partial — pred is substring of gold: `Priv.-Doz. Mag. Dr. Henriette Boscheinen-Duursma LL.M., MAS, LL.M.`
...
**Example 1** (doc_id: `deanon_260716_TRAIN/5Ob221_22v`) (sent_id: `deanon_260716_TRAIN/5Ob221_22v_3`)
...
- `Kostic` — partial — pred is substring of gold: `Mag. Alexander Todor-Kostic`
