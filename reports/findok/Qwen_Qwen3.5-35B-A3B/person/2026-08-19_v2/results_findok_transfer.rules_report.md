# Rule Evaluation Report — Qwen/Qwen3.5-35B-A3B (findok)

Generated on: 2026-08-20T04:09:46.511147
...
| Phase1 Train Sentences | 2914 |
| Phase1 Eval Sentences | 776 |
| Transfer Train Sentences | 4815 |
| Transfer Eval Sentences | 1344 |
| Best Batch Idx | 61 |
| Best Batch F1 | 0.34226256364843927 |
| Best Rules Serialized | [{'id': '336950c7', 'name': 'academic_suffix_name', 'description': 'Matches person names with academic suffixes (MSc, LL.M., etc.) including preceding titles (Mag., Dr.) and suffixes like MBA, M.B.L.', 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*\\s+(?:MSc|LL\\.M\\.|B\\.Sc\\.|M\\.Sc\\.|B\\.A\\.|M\\.A\\.|Ph\\.D\\.|Dr\\.\\s+iur\\.|Bakk\\.\\s+iur\\.|Dipl\\.\\s+iur\\.|MBA|M\\.B\\.L\\.|M\\.B\\.L\\.)(?:\\s*,\\s*[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)\\b(?![,\\s])', 'priority': 7, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '843bb75c', 'name': 'preposition_name', 'description': "Captures names with prepositions like 'auf der', 'von der', 'zu der' which are common in German names (e.g., 'Renata auf der Heyde'). Fixed to capture only the name.", 'format': 'regex', 'content': '(?:auf\\s+der\\s+|von\\s+der\\s+|zu\\s+der\\s+|aus\\s+der\\s+|an\\s+der\\s+)([A-Z][a-z]+(?:\\s+[A-Z][a-z]+)+)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '71881870', 'name': 'born_context_name', 'description': "Captures names following 'geboren am' (born on) which is a common pattern for identifying individuals.", 'format': 'regex', 'content': 'geboren\\s+am\\s+([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+[A-Z][a-zäöüßéèêëïîôùûü]+)*)\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2db930ba', 'name': 'accused_context_name', 'description': "Captures names following 'Angeklagte' (accused) or 'Angeklagten' to identify defendants, ensuring only the name is captured.", 'format': 'regex', 'content': '(?:Angeklagte|Angeklagten)\\s+([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+[A-Z][a-zäöüßéèêëïîôùûü]+)*)\\b(?![a-z])', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '78d8dfa8', 'name': 'verb_context_name', 'description': "Captures names following verbs like 'ist', 'wurde', 'lebte' which often precede person names in legal texts, specifically for cases like 'lebte mit Ernst Schoenekaess'. Excludes common professions and abstract nouns.", 'format': 'regex', 'content': '(?:lebte\\s+mit\\s+|heiratete\\s+die\\s+|heiratete\\s+den\\s+|wurde\\s+|ist\\s+|konnte\\s+|sollte\\s+)([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+[A-Z][a-zäöüßéèêëïîôùûü]+)+)\\b(?![a-z])(?!\\s*(?:Rechtsanwälte|Anwälte|Partnerschaft|GmbH|AG|KG|Gesellschaft|Firma|Unternehmen|Bildung|Dienstleistungen|Versicherung|Bank|Konto|Kredit|Darlehen|Hypothek|Steuer|Finanz|Gericht|Kammer|Behörde|Amt|Ministerium|Bundes|Land|Stadt|Gemeinde|Ort|Bezirk|Kreis|Region|Lage|Position|Stelle|Job|Beruf|Tätigkeit|Funktion|Rolle|Aufgabe|Pflicht|Recht|Anspruch|Klage|Klagegrund|Klageantrag|Klagebegründung|Klageerwiderung|Klageantwort|Klageerhebung|Klageverhandlung|Klageentscheidung|Klageurteil|Klagebeschluss|Klageverfahren|Klagekosten|Klagegebühr|Klagefrist|Klageverjährung|Klageverwirkung|Klageverzicht|Revisionsgericht|Berufungsgericht|Oberste|Gerichtshof|Senatspräsidentin|Vizepräsident|Vizepräsidentin|Rekursgericht|Kontaktrecht|Dr\\.\\s+|Mag\\.\\s+|Prof\\.\\s+|Univ\\.\\s+|Hon\\.\\s+|MMag\\.\\s+|DI\\.\\s+|Ing\\.\\s+|Bakk\\.\\s+|PhD\\.\\s+|HR\\.\\s+|Techn\\.\\s+|Dipl\\.\\s+|PD\\.\\s+|Priv\\.\\s+|KommR\\.\\s+|ÖkR\\.\\s+|RgR\\.\\s+|StR\\.\\s+|MedR\\.\\s+|KzlR\\.\\s+|OMedR\\.\\s+|VetR\\.\\s+|AR\\.\\s+|Vizepräsident\\s+|Senatspräsident\\s+|Hofrat\\s+|Hofrätin\\s+|Hofräts\\s+|Vizepräsidentin\\s+|Senatspräsidentin\\s+|Jugendhilfeträger|Mutter|Vater|Eltern|Kind|Sohn|Tochter|Gewährung|Unterhaltsvorschuss|Strafsachen|Zivilrechtssachen|Maurer|Schalungsbauer|Anzahl|Verbrechen|Missbrauchs|Unmündigen|Geborenen|Schuld|Tatzeitraum|Verfahren|Nichtigkeitsb))', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '2af0d0f5', 'name': 'senatspraesident_name', 'description': "Captures names following 'Senatspräsidenten', 'Senatspräsidentin', 'Vizepräsidenten', 'Vizepräsidentin' to avoid matching the title or preceding institution.", 'format': 'regex', 'content': '(?:Senatspräsident(?:en|in)|Vizepräsident(?:en|in))\\s+(?:des\\s+)?(?:des\\s+)?(?:Obersten\\s+Gerichtshofs\\s+)?(?<!\\w)([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+(?:[A-Z]\\.|\\s+[A-Z][a-z]+|-?[A-Z][a-z]+)+)*)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'ea45e77c', 'name': 'family_relation_name', 'description': "Captures names following family relation terms like 'von' in 'Eltern von' or 'Mutter von' to identify persons without titles.", 'format': 'regex', 'content': '(?:Eltern\\s+von\\s+|Mutter\\s+von\\s+|Vater\\s+von\\s+|Sohn\\s+von\\s+|Tochter\\s+von\\s+)([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df]+)+)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '571abaa8', 'name': 'witness_context_name', 'description': "Captures names following 'Zeuge', 'Zeugin', 'Zeugen' (witness) to identify witnesses in legal texts.", 'format': 'regex', 'content': '(?:Zeuge|Zeugin|Zeugen)\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00ee\\u00f4\\u00fb]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00ee\\u00f4\\u00fb]+)*)', 'priority': 7, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'ce93ecd2', 'name': 'accusative_genitive_name', 'description': "Captures person names following legal role terms in accusative or genitive cases (e.g., 'des Angeklagten', 'der Zehra Dreissig') to identify defendants, witnesses, etc., without titles.", 'format': 'regex', 'content': '(?:dem\\s+Angeklagten|des\\s+Angeklagten|den\\s+Angeklagten|der\\s+Angeklagten|dem\\s+Beschuldigten|des\\s+Beschuldigten|den\\s+Beschuldigten|der\\s+Beschuldigten|dem\\s+Zeugen|des\\s+Zeugen|den\\s+Zeugen|der\\s+Zeugin|dem\\s+Beklagten|des\\s+Beklagten|den\\s+Beklagten|der\\s+Beklagten|dem\\s+Kläger|des\\s+Klägers|den\\s+Klägern|der\\s+Klägerin|dem\\s+Opfer|des\\s+Opfers|den\\s+Opfern|der\\s+Opferin|dem\\s+Verteidiger|des\\s+Verteidigers|den\\s+Verteidigern|der\\s+Verteidigerin|dem\\s+Anwalt|des\\s+Anwalts|den\\s+Anwälten|der\\s+Anwältin|dem\\s+Notar|des\\s+Notars|den\\s+Notaren|der\\s+Notarin|dem\\s+Richter|des\\s+Richters|den\\s+Richtern|der\\s+Richterin|dem\\s+Staatsanwalt|des\\s+Staatsanwalts|den\\s+Staatsanwälten|der\\s+Staatsanwältin|dem\\s+Vizepräsidenten|des\\s+Vizepräsidenten|den\\s+Vizepräsidenten|der\\s+Vizepräsidentin|dem\\s+Senatspräsidenten|des\\s+Senatspräsidenten|den\\s+Senatspräsidenten|der\\s+Senatspräsidentin|dem\\s+Hofrat|des\\s+Hofrats|den\\s+Hofräten|der\\s+Hofrätin|dem\\s+Hofräts|des\\s+Hofräts|den\\s+Hofräten|der\\s+Hofrätin)(?:\\s+|,|\\.|$)([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+[A-Z][a-zäöüßéèêëïîôùûü]+)+)(?:\\s*(?:,|\\.|$|\\s+und\\s+|\\s+von\\s+|\\s+als\\s+))(?!\\s*(?:Ltd|GmbH|AG|KG|Rechtsanw|Anwalt|Gesellschaft|Partei|Firma|Unternehmen|Form|Abs|Absatz|Nr|Nr\\.|Vorsitzenden|Vorsitzende|Senatspräsident|Hofrat|Hofräts|Angeklagte|Angeklagten|Zeugin|Zeuge|Beklagte|Beklagten|Klägerin|Kläger|Abstimmung|Feststellung|Ansehen|Strafe|Arbeitgeber|Arbeitnehmer|Sozialrechtssachen|Sozialgericht|Rente|Familie|Unterhaltsvorschuss|Unterhaltsverpflichteten|Frau|Landl|Verhandlung|Ausfertigung|Erkenntnis|Vorsitzenden|Vorsitzende|Maurer|Fliesenleger|Arbeiter|Ingenieur|Lehrer|Arzt|Notar|Bank|Konto|Kredit|Darlehen|Hypothek|Versicherung|Versicherungs|Steuer|Finanz|Finanzamt|Gericht|Kammer|Behörde|Amt|Ministerium|Bundes|Land|Stadt|Gemeinde|Ort|Bezirk|Kreis|Region|Lage|Position|Stelle|Job|Beruf|Tätigkeit|Funktion|Rolle|Aufgabe|Pflicht|Recht|Anspruch|Klage|Klagegrund|Klageantrag|Klagebegründung|Klageerwiderung|Klageantwort|Klageerhebung|Klageverhandlung|Klageentscheidung|Klageurteil|Klagebeschluss|Klageverfahren|Klagekosten|Klagegebühr|Klagefrist|Klageverjährung|Klageverwirkung|Klageverzicht|Revisionsgericht|Berufungsgericht|Oberste|Gerichtshof|Senatspräsidentin|Vizepräsident|Vizepräsidentin|Rekursgericht|Kontaktrecht|Dr\\.|Mag\\.|Prof\\.|Univ\\.|Hon\\.|MMag\\.|DI\\.|Ing\\.|Bakk\\.|PhD\\.|HR\\.|Techn\\.|Dipl\\.|PD\\.|Priv\\.|KommR\\.|ÖkR\\.|RgR\\.|StR\\.|MedR\\.|KzlR\\.|OMedR\\.|VetR\\.|AR\\.|Vizepräsident\\s+|Senatspräsident\\s+|Hofrat\\s+|Hofrätin\\s+|Hofräts\\s+|Vizepräsidentin\\s+|Senatspräsidentin\\s+|Jugendhilfeträger|Mutter|Vater|Eltern|Kind|Sohn|Tochter|Gewährung|Unterhaltsvorschuss))', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'fcc80868', 'name': 'mj_minor_name', 'description': "Captures names following 'mj' (minderjährig) which indicates a minor person in legal texts.", 'format': 'regex', 'content': '\\bmj\\s+([A-Z][a-zäöüßéèêëïîôùûü]+(?:\\s+[A-Z][a-zäöüßéèêëïîôùûü]+)*)\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'a1335c60', 'name': 'single_initial_person_2', 'description': "Captures single initials (e.g., 'M.', 'E.') when they appear in contexts indicating a person (e.g., 'Sohn C. M.', 'Firma Y. GmbH').", 'format': 'regex', 'content': '(?:Sohn\\s+[A-Z]\\s+([A-Z]\\.)|Firma\\s+([A-Z]\\.)\\s+GmbH|Vereinbarung\\s+getroffen,\\s+dass\\s+die\\s+([A-Z]\\.)\\s+eine)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '92c2ef4c', 'name': 'anonymous_person_dr', 'description': "Captures anonymous persons denoted by 'Dr. X.' or similar single-letter citations in quotes or specific contexts.", 'format': 'regex', 'content': '(?:\\u201e|\\u201c|\\u201d|\\u201c|"|\\()Dr\\.\\s+([A-Z]\\.)\\s*(?:\\)|\\u201d|\\u201d|"|\\s|$)', 'priority': 9, 'output_template': {'text': 'Dr. $1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '211a4808', 'name': 'von_title_name', 'description': "Captures names following 'von' + Title (e.g., 'von Herrn Esra Lindacher', 'von Dr. Stephan Schiwy') to extract the name without the title.", 'format': 'regex', 'content': '(?:von\\s+(?:Herrn|Herr|Frau|Fr\\.\\s+|Dr\\.|Mag\\.|Prof\\.|Univ\\.-?Prof\\.|Priv\\.-?Doz\\.|Hon\\.-?Prof\\.|Ing\\.|Dipl\\.-?Ing\\.|Bakk\\.|StR\\s+|OMedR\\s+|KzlR\\s+|\\u00d6kR\\s+|RgR\\s+|MedR\\s+|KommR\\s+|Vizepr\\u00e4sident\\s+|Senatspr\\u00e4sident\\s+|Hofrat\\s+|Hofr\\u00e4tin\\s+|Hofr\\u00e4ts\\s+|Vizepr\\u00e4sidentin\\s+|Senatspr\\u00e4sidentin\\s+|Dr\\.in|Mag\\.a)\\s+)([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)+)\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'a31d3f83', 'name': 'herr_initial_person', 'description': "Captures person initials following 'Herr' (e.g., 'Herr JG').", 'format': 'regex', 'content': '\\bHerr\\s+([A-Z]{2,3})\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '4768de29', 'name': 'richter_initial_person', 'description': "Captures single initials following 'Richter' or 'Richterin' (e.g., 'Richter I.').", 'format': 'regex', 'content': '\\b(?:Richter|Richterin)\\s+([A-Z]\\.)\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'f62c0124', 'name': 'contextual_name_no_title', 'description': "Captures person surnames following legal case markers ('in der Sache', 'in der ...-Entscheidung') and possessive phrases ('von Frau', 'von Herrn', 'bei der'), ensuring full surname capture and excluding trailing punctuation.", 'format': 'regex', 'content': '(?:in\\s+der\\s+(?:Sache|Beschwerdesache|Verwaltungsstrafsache|Rechtssache|Verfahren|Entscheidung|Urteil|Sache\\s+\\w+)|von\\s+(?:Frau|Herrn|Herr|Frau\\s+\\w+)|bei\\s+der|bei\\s+den|bei\\s+einem|bei\\s+einer)\\s+(?<!\\w)([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)\\b(?![,\\s])', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '34129a99', 'name': 'herr_frau_name', 'description': "Captures names following 'Herr' or 'Frau' titles, ensuring the full name is captured including suffixes, and excluding trailing punctuation.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:Herr|Frau)\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)\\b(?![,\\s])', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'af8afcca', 'name': 'definite_article_person', 'description': "Captures person names preceded by 'die' or 'den' followed by a legal role (Richter, etc.) or specific context. FIXED to capture the full name including any title immediately following the role.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:die\\s+(?:Richter|Richterin|Senatsvorsitzende|Vizepr\\u00e4sident|Vizepr\\u00e4sidentin|Senatspr\\u00e4sident|Senatspr\\u00e4sidentin)|den\\s+(?:Richter|Richterin|Senatsvorsitzende|Vizepr\\u00e4sident|Vizepr\\u00e4sidentin|Senatspr\\u00e4sident|Senatspr\\u00e4sidentin|steu\\u00e4rlichen\\s+Vertreter|steuerlichen\\s+Vertreter))\\s+(?:Dr\\.|Dr\\.in|Mag\\.|Mag\\.a|Mag\\.Mag\\.|MMag\\.|DI\\.|Ing\\.|Bakk\\.|Dipl\\.|Univ\\.-?Prof\\.|Prof\\.|Priv\\.-?Doz\\.|DDr\\.|KommR\\.|\\u00d6kR\\.|RgR\\.|MedR\\.|VetR\\.|AR\\.|OMedR\\.|KzlR\\.|HR\\.|Techn\\.|PhD\\.|Senatspr\\u00e4sident\\.|Vizepr\\u00e4sident\\.|Hofrat\\.|Hofr\\u00e4tin\\.|Hofr\\u00e4ts\\.|Vizepr\\u00e4sidentin\\.|Senatspr\\u00e4sidentin\\.|Hon\\.-?Prof\\.|OStR|OStRin|Priv\\.-?Doz\\.in|Univ\\.-?Prof\\.in|OStR(?:\\s+Ing\\.)?|OStRin|KzlR|StR|MedR|KommR|\\u00d6kR|VetR|Vizepr\\u00e4sident|Senatspr\\u00e4sident|Hofrat|Hofr\\u00e4tin|Hofr\\u00e4ts|Vizepr\\u00e4sidentin|Senatspr\\u00e4sidentin|Prof\\.in\\s+Techn\\s+R|Univ\\.-?Prof\\.)?\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'd228660e', 'name': 'von_role_name', 'description': "Captures names following 'von' + [Legal Role] (e.g., 'von Zweitbeschuldigten', 'vom Erstbeschuldigten') to handle genitive case patterns where the role precedes the name.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:von\\s+(?:dem|der|den|einem|einer|dem|des|dem|dem)|vom|von\\s+der|von\\s+den|von\\s+einem|von\\s+einer)\\s+(?:Zweitbeschuldigten|Erstbeschuldigten|Beschwerdef\\u00fchrer|Beschwerdef\\u00fchrerin|Angeklagte|Angeklagten|Antragsteller|Antragstellerin|Antragsgegner|Antragsgegnerin|Partei|Parteien|Zeuge|Zeugin|Zeugen|Kl\\u00e4ger|Kl\\u00e4gerin|Beklagte|Beklagten|Vertreter|vertreten|Sohn|Kind|Frau|Herrn|Herr|die|den|des|der|dem)\\s+(?<!\\w)([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)+)(?:\\s*,\\s*(?:Bakk\\.\\s+(?:art\\.|techn\\.|iur\\.|jur\\.|phil\\.)|MBA|M\\.Sc|LL\\.B\\.\\s*LL\\.M\\.|LL\\.M\\.|PhD|Dr\\.|Mag\\.)?)?\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '5e5a7a12', 'name': 'herr_context_name', 'description': "Captures names following 'Herr' or 'Herrn', including initials and suffixes like 'B.' or 'B'. FIXED to capture only the name, excluding the title 'Herr'.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)Herr(?:n)?\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+\\.)?)', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '0ddd9a21', 'name': 'title_only_person', 'description': "Captures person names immediately following a title (e.g., 'Dr. Hans', 'Mag. Dr. Wolfgang', 'VetR Hon.-Prof.in Leya'). Handles compound titles and academic suffixes. FIXED to capture the full name including suffixes.", 'format': 'regex', 'content': '(?<!\\w)(?:RA\\s+|Hon\\.-?Prof\\.|Univ\\.-?Prof\\.|Univ\\.-?Prof\\.in|Prof\\.|Dr\\.|Dr\\.in|Mag\\.|Mag\\.a|Mag\\.Mag\\.|Dr\\.Mag\\.|MMag\\.|DI\\.|Ing\\.|Ing\\.KomzlR\\.|Bakk\\.\\s+iur\\.|PhD\\.|HR\\s+Ing\\.|Techn\\s+R|TechnR|Dipl\\.-?HTL\\-?Ing\\.|PD\\s+Dr\\.|Priv\\.-?Doz\\.|Priv\\.-?Doz\\.in|DDr\\.|KommR\\s+|\\u00d6kR\\s+|RgR\\s+|StR\\s+|MedR\\s+|HR\\s+|KzlR\\s+|OMedR\\s+|VetR\\s+|AR\\s+|Vizepr\\u00e4sident\\s+|Senatspr\\u00e4sident\\s+|Hofrat\\s+|Hofr\\u00e4tin\\s+|Hofr\\u00e4ts\\s+|Vizepr\\u00e4sidentin\\s+|Senatspr\\u00e4sidentin\\s+|Dr\\.in|Mag\\.a|Mag\\.Dr\\.|Dr\\.Mag\\.|Dipl\\.\\s+|Univ\\.-?Prof\\.\\s+Dipl\\.-?Ing\\.\\s+Dr\\.|Priv\\.-?Doz\\.\\s+|Prof\\.in\\s+Techn\\s+R|OStR|OStRin|Priv\\.-?Doz\\.in\\s+Mag\\.a|Priv\\.-?Doz\\.in|OStR(?:\\s+Ing\\.)?|OStRin|KzlR|StR|MedR|KommR|\\u00d6kR|VetR|Vizepr\\u00e4sident|Senatspr\\u00e4sident|Hofrat|Hofr\\u00e4tin|Hofr\\u00e4ts|Vizepr\\u00e4sidentin|Senatspr\\u00e4sidentin|Prof\\.in\\s+Techn\\s+R|Univ\\.-?Prof\\.)\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s*,\\s*(?:LL\\.B\\.|LL\\.M\\.|M\\.Sc|M\\.B\\.L\\.|MBA|PhD|Dr\\.|Mag\\.)?)?)', 'priority': 10, 'output_template': {'text': '$0', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': '975d50e9', 'name': 'richter_context_name', 'description': "Captures person names following 'Richter' or 'Richterin' when a title is present, ensuring the full name including title is captured.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:Richter|Richterin)\\s+(?:Dr\\.|Dr\\.in|Mag\\.|Mag\\.a|Mag\\.Mag\\.|MMag\\.|DI\\.|Ing\\.|Bakk\\.|Dipl\\.|Univ\\.-?Prof\\.|Prof\\.|Priv\\.-?Doz\\.|DDr\\.|KommR\\.|\\u00d6kR\\.|RgR\\.|MedR\\.|VetR\\.|AR\\.|OMedR\\.|KzlR\\.|HR\\.|Techn\\.|PhD\\.|Senatspr\\u00e4sident\\.|Vizepr\\u00e4sident\\.|Hofrat\\.|Hofr\\u00e4tin\\.|Hofr\\u00e4ts\\.|Vizepr\\u00e4sidentin\\.|Senatspr\\u00e4sidentin\\.|Hon\\.-?Prof\\.|OStR|OStRin|Priv\\.-?Doz\\.in|Univ\\.-?Prof\\.in|OStR(?:\\s+Ing\\.)?|OStRin|KzlR|StR|MedR|KommR|\\u00d6kR|VetR|Vizepr\\u00e4sident|Senatspr\\u00e4sident|Hofrat|Hofr\\u00e4tin|Hofr\\u00e4ts|Vizepr\\u00e4sidentin|Senatspr\\u00e4sidentin|Prof\\.in\\s+Techn\\s+R|Univ\\.-?Prof\\.)?\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)', 'priority': 10, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'ba721a93', 'name': 'single_initial_person', 'description': "Captures single initials (e.g., 'M.', 'E.') in specific contexts like 'Richter M.' or 'M. Lehner' to avoid false positives.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:Richter|Richterin|Vorsitzender|Vorsitzende|Mag\\.\\s+|Dr\\.\\s+|Prof\\.\\s+|Univ\\.-?Prof\\.|Senatspr\\u00e4sident|Vizepr\\u00e4sident|Hofrat|Hofr\\u00e4tin|Herr|Frau|von\\s+|bei\\s+|mit\\s+|durch\\s+|gegen\\s+|f\\u00fcr\\s+|in\\s+|aus\\s+|zu\\s+|nach\\s+|vor\\s+|unter\\s+|\\u00fcber\\s+|auf\\s+|ohne\\s+|um\\s+|seit\\s+|bis\\s+|ab\\s+|wider\\s+|neben\\s+|zwischen\\s+|entlang\\s+|gegen\\u00fcber\\s+|statt\\s+|au\\u00dfer\\s+|Sohn\\s+|Kind\\s+|Eltern\\s+|Mutter\\s+|Vater\\s+|Bruder\\s+|Schwester\\s+|Onkel\\s+|Tante\\s+|Cousin\\s+|Cousine\\s+|Gro\\u00dfvater\\s+|Gro\\u00dfmutter\\s+|Enkel\\s+|Enkelin\\s+|Neffe\\s+|Nichte\\s+|Tante\\s+|Onkel\\s+|Urgro\\u00dfvater\\s+|Urgro\\u00dfmutter\\s+|Urenkel\\s+|Urenkelin\\s+|Gro\\u00dfonkel\\s+|Gro\\u00dftante\\s+|Gro\\u00dfneffe\\s+|Gro\\u00dfnichte\\s+|Gro\\u00dfcousin\\s+|Gro\\u00dfcousine\\s+|Gro\\u00dfvater\\s+|Gro\\u00dfmutter\\s+|Enkel\\s+|Enkelin\\s+|Neffe\\s+|Nichte\\s+|Tante\\s+|Onkel\\s+|Urgro\\u00dfvater\\s+|Urgro\\u00dfmutter\\s+|Urenkel\\s+|Urenkelin\\s+|Gro\\u00dfonkel\\s+|Gro\\u00dftante\\s+|Gro\\u00dfneffe\\s+|Gro\\u00dfnichte\\s+|Gro\\u00dfcousin\\s+|Gro\\u00dfcousine\\s+)([A-Z]\\.)\\b', 'priority': 8, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}, {'id': 'b457b19b', 'name': 'case_marker_name', 'description': "Captures person names following legal case markers like 'Beschwerdesache', 'Revisionssache', etc., ensuring only the name is captured. TIGHTENED to require a full name immediately after the marker to avoid partial matches like 'Rg' or 'Hon'.", 'format': 'regex', 'content': '(?:^|\\s|,|\\(|\\)|\\[|\\]|\\.|\\?|!|\\n)(?:Beschwerdesache|Revisionssache|Verwaltungsstrafsache|Strafsache|Zivilsache|Familiensache|Nachlasssache|Insolvenzsache|Konkurssache|Vollstreckungssache|Geldw\\u00e4schereisache|Kartellsache|Wettbewerbsrechtssache|Sozialversicherungssache|Arbeitsrechtssache|Verwaltungsgerichtsbarkeitssache|Verfassungsgerichtssache|Verwaltungsstrafgesetzssache|Bundesfinanzgerichtssache|Finanzstrafssache|Finanzverwaltungsstrafssache|Finanzverwaltungsstrafverfahrenssache|Finanzverwaltungsstrafverfahren|Finanzverwaltungsstrafverfahrens|Finanzverwaltungsstrafverfahrensf\\u00e4lle|Finanzverwaltungsstrafverfahrensfalls|Finanzverwaltungsstrafverfahrensf\\u00e4llen|Finanzverwaltungsstrafverfahrensfalls|Finanzverwaltungsstrafverfahrensf\\u00e4lle|Finanzverwaltungsstrafverfahrensfalls|Finanzverwaltungsstrafverfahrensf\\u00e4llen|Finanzverwaltungsstrafverfahrensfalls)\\s+([A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+(?:\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*(?:\\s+-\\s+[A-Z][a-z\\u00e4\\u00f6\\u00fc\\u00df\\u00e9\\u00e8\\u00ea\\u00eb\\u00ef\\u00ee\\u00f4\\u00f9\\u00fb\\u00fc]+)*)', 'priority': 9, 'output_template': {'text': '$1', 'start': '$start', 'end': '$end', 'type': 'person'}, 'output_key': 'entities'}] |
...
| True Positives | 773 |
| False Positives | 1353 |
| False Negatives | 1618 |
| Total Gold Entities | 2391 |
| Micro Precision | 36.4% |
| Micro Recall | 32.3% |
| Micro F1 | 34.2% |
| Macro F1 | 34.2% |
...
| `herr_context_name` | 8.1% | 71.3% | 4.3% | 143 | 102 | 41 |
...
**F1:** 0.081 | **Precision:** 0.713 | **Recall:** 0.043  

**Format:** `regex`  
**Rule ID:** `5e5a7a12`  
**Description:**
Captures names following 'Herr' or 'Herrn', including initials and suffixes like 'B.' or 'B'. FIXED to capture only the name, excluding the title 'Herr'.

**Content:**
```
(?:^|\s|,|\(|\)|\[|\]|\.|\?|!|\n)Herr(?:n)?\s+([A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00e9\u00e8\u00ea\u00eb\u00ef\u00ee\u00f4\u00f9\u00fb\u00fc]+(?:\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00e9\u00e8\u00ea\u00eb\u00ef\u00ee\u00f4\u00f9\u00fb\u00fc]+)*(?:\s+-\s+[A-Z][a-z\u00e4\u00f6\u00fc\u00df\u00e9\u00e8\u00ea\u00eb\u00ef\u00ee\u00f4\u00f9\u00fb\u00fc]+)*(?:\s+\.)?)
```
...
**Example 25** (doc_id: `deanon_BFG_20260814_TRAIN/134126.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134126.1_25`)
...
**Example 26** (doc_id: `deanon_BFG_20260814_TRAIN/134126.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134126.1_32`)
...
**Example 27** (doc_id: `deanon_BFG_20260814_TRAIN/134126.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134126.1_33`)
...
**Example 28** (doc_id: `deanon_BFG_20260814_TRAIN/134126.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134126.1_38`)
...
**Example 29** (doc_id: `deanon_BFG_20260814_TRAIN/135161.1`) (sent_id: `deanon_BFG_20260814_TRAIN/135161.1_87`)
...
**Example 30** (doc_id: `deanon_BFG_20260814_TRAIN/135933.1`) (sent_id: `deanon_BFG_20260814_TRAIN/135933.1_6`)
...
**Example 31** (doc_id: `deanon_BFG_20260814_TRAIN/135933.1`) (sent_id: `deanon_BFG_20260814_TRAIN/135933.1_17`)
...
**Example 32** (doc_id: `deanon_BFG_20260814_TRAIN/135933.1`) (sent_id: `deanon_BFG_20260814_TRAIN/135933.1_29`)
...
**Example 33** (doc_id: `deanon_BFG_20260814_TRAIN/135933.1`) (sent_id: `deanon_BFG_20260814_TRAIN/135933.1_52`)
...
**Example 34** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_21`)
...
**Example 35** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_22`)
...
**Example 36** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_24`)
...
**Example 37** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_25`)
...
**Example 38** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_26`)
...
**Example 39** (doc_id: `deanon_BFG_20260814_TRAIN/138498.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138498.1_5`)
...
**Example 40** (doc_id: `deanon_BFG_20260814_TRAIN/139589.1`) (sent_id: `deanon_BFG_20260814_TRAIN/139589.1_26`)
...
**Example 41** (doc_id: `deanon_BFG_20260814_TRAIN/139698.1`) (sent_id: `deanon_BFG_20260814_TRAIN/139698.1_1`)
...
**Example 42** (doc_id: `deanon_BFG_20260814_TRAIN/139698.1`) (sent_id: `deanon_BFG_20260814_TRAIN/139698.1_36`)
...
**Example 43** (doc_id: `deanon_BFG_20260814_TRAIN/139698.1`) (sent_id: `deanon_BFG_20260814_TRAIN/139698.1_37`)
...
**Example 44** (doc_id: `deanon_BFG_20260814_TRAIN/139698.1`) (sent_id: `deanon_BFG_20260814_TRAIN/139698.1_62`)
...
**Example 45** (doc_id: `deanon_BFG_20260814_TRAIN/140794.1`) (sent_id: `deanon_BFG_20260814_TRAIN/140794.1_4`)
...
**Example 46** (doc_id: `deanon_BFG_20260814_TRAIN/141720.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141720.1_190`)
...
**Example 47** (doc_id: `deanon_BFG_20260814_TRAIN/141720.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141720.1_198`)
...
**Example 48** (doc_id: `deanon_BFG_20260814_TRAIN/141761.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141761.1_8`)
...
**Example 49** (doc_id: `deanon_BFG_20260814_TRAIN/141761.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141761.1_13`)
...
**Example 50** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_3`)
...
**Example 51** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_6`)
...
**Example 52** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_8`)
...
**Example 53** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_16`)
...
**Example 54** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_17`)
...
**Example 55** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_20`)


Am 17.05.2022 langte beim Finanzamt ein Schreiben von Herrn Alan Zygan  mit dem Betreff  „Beschwerdevorentscheidung zur Beschwerde vom 19.11.2021“ ein, in dem wie folgt  ausgeführt wird: „Sehr geehrte Damen und Herren!

| Predicted | Gold |
|---|---|
| `Alan Zygan` | `Alan Zygan` |

**Missed by this rule (FN):**

- `Finanzamt` (organisation)

**Example 56** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_35`)


Im Vorlagebericht beantragte es die Zurückweisung der Beschwerde, da das  am 17.05.2022 beim Finanzamt eingelangte Schreiben von Herrn Alan Zygan  erst am 17.05.2022  postalisch versandt worden ist;
...
**Example 57** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_55`)
...
**Example 58** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_59`)
...
**Example 59** (doc_id: `deanon_BFG_20260814_TRAIN/142519.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142519.1_60`)


Überdies wird von Herrn Alan Zygan  ausgeführt: Er sei in  nachvollziehbarer Weise davon ausgegangen, dass die an ihn monatlich geleisteten Zahlungen  mit Unterhaltscharakter zu Recht erfolgten, zumal er stets alle Bestätigungen der Universität  fristgerecht vorgelegt habe.

| Predicted | Gold |
|---|---|
| `Alan Zygan` | `Alan Zygan` |

**Example 60** (doc_id: `deanon_BFG_20260814_TRAIN/142976.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142976.1_6`)
...
**Example 61** (doc_id: `deanon_BFG_20260814_TRAIN/144543.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144543.1_36`)


Sie habe persönliche Assistenz und Herr Schleef sei einer ihrer Assistent:innen (Verweis auf den  beigefügten Lohnzettel).

| Predicted | Gold |
|---|---|
| `Schleef` | `Schleef` |

**Example 62** (doc_id: `deanon_BFG_20260814_TRAIN/144555.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144555.1_5`)
...
| Predicted | Gold |
|---|---|
| `Vivian Hartmann` | `Vivian Hartmann` |

**Example 63** (doc_id: `deanon_BFG_20260814_TRAIN/144625.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144625.1_22`)


unentgeltlich an Herrn Stella Henkels  übertragen.

| Predicted | Gold |
|---|---|
| `Stella Henkels` | `Stella Henkels` |

**Example 64** (doc_id: `deanon_BFG_20260814_TRAIN/144851.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144851.1_6`)


Entscheidungsgründe  Mit Straferkenntnis vom 16. April 2024, Zahl: MA67/246700162299/2024, hat der Magistrat  der Stadt Wien, Magistratsabteilung 67, als belangte Behörde Herrn Moritz Flanagan (in weiterer  Folge: Beschwerdeführer – Bf) angelastet, er habe die Parkometerabgabe fahrlässig verkürzt  indem er das mehrspurige Kraftfahrzeug mit dem behördlichen Kennzeichen LN-327 LZ  am  2. Februar 2024 um 09:20 Uhr in einer gebührenpflichtigen Kurzparkzone in 1210 Wien,  1 von 5 Seite 2 von 5

| Predicted | Gold |
|---|---|
| `Moritz Flanagan` | `Moritz Flanagan` |

**Missed by this rule (FN):**

- `Magistrat  der Stadt Wien` (organisation)
- `LN-327 LZ` (vehicle_license)

**Example 65** (doc_id: `deanon_BFG_20260814_TRAIN/144916.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144916.1_6`)


Mit Eingabe vom 22. März 2023 stellte der Sohn, Herr Nicole Heidepeter (= Beschwerdeführer), für die  Verlassenschaft nach A einen Antrag auf Arbeitnehmerveranlagung für das Jahr 2022.

| Predicted | Gold |
|---|---|
| `Nicole Heidepeter` | `Nicole Heidepeter` |

**Example 66** (doc_id: `deanon_BFG_20260814_TRAIN/144971.1`) (sent_id: `deanon_BFG_20260814_TRAIN/144971.1_1`)


IM NAMEN DER REPUBLI K  Das Bundesfinanzgericht erkennt durch den Richter Mag. Günter Narat in der  Beschwerdesache Theophil Steinl, Mozartweg 23, 4595 Steinersdorf, Österreich  Steuernummer: 56-732/9693, vertreten  durch den Steuerberater Herrn Martin Friedl, Marktplatz 2, 4650 Lambach, über die  Beschwerde vom 13. März 2023 gegen den Bescheid des Finanzamtes Österreich vom 9.  Februar 2023 betreffend Aufhebung gemäß § 299 BAO hinsichtlich Festsetzung der  Kapitalertragsteuer 2020 vom 19. September 2022 zu Recht:  I)  Der Beschwerde wird gem. § 279 BAO Folge gegeben.
...
- `Theophil Steinl` (person)
- `Mozartweg 23, 4595 Steinersdorf, Österreich` (address)
- `56-732/9693` (tax_number)
- `Finanzamtes Österreich` (organisation)

**Example 67** (doc_id: `deanon_BFG_20260814_TRAIN/145067.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145067.1_16`)


Der festgestellte Grad der Behinderung wird voraussichtlich mehr als 3 Jahre andauern:    ja  GdB liegt vor seit:   03/2022  Herr Sascha Hagdorn  ist voraussichtlich dauernd außerstande, sich selbst den Unterhalt zu  verschaffen:  JA  Dies besteht seit:      03/2022  2 von 14 Seite 3 von 14

| Predicted | Gold |
|---|---|
| `Sascha Hagdorn` | `Sascha Hagdorn` |

**Example 68** (doc_id: `deanon_BFG_20260814_TRAIN/145067.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145067.1_55`)


Herr Sascha Hagdorn  ist voraussichtlich dauernd außerstande, sich selbst den Unterhalt zu  verschaffen:  JA  Dies besteht seit:      03/2022  Anmerkung bzw Begründung betreffend die Fähigkeit bzw voraussichtlich dauernde  Unfähigkeit, sich selbst den Unterhalt zu verschaffen:  Aus den vorliegenden Unterlagen geht nicht genau hervor, ab welchem Zeitpunkt eine  dauerhafte Erwerbsunfähigkeit bestanden hat.

| Predicted | Gold |
|---|---|
| `Sascha Hagdorn` | `Sascha Hagdorn` |

**Example 69** (doc_id: `deanon_BFG_20260814_TRAIN/145271.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145271.1_25`)


Dieser  Mängelbehebungsauftrag wurde am 14.11.2016 ordnungsgemäß mit Hinterlegung zugestellt.  In weiterer Folge wurde dieser von Herrn Melina Jakumeit  nicht behoben und gelangte zurück an die  Finanzstrafbehörde.

| Predicted | Gold |
|---|---|
| `Melina Jakumeit` | `Melina Jakumeit` |

**Example 70** (doc_id: `deanon_BFG_20260814_TRAIN/145910.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145910.1_30`)


Gerade Herr Urs Ahrenholz  betreut sehr viele Kunden (dies ist auch aus seinem hohen Umsatz  ersichtlich) und ist somit auf eine Sekretärin angewiesen, da dieser Umsatz sonst alleine nur  schwer zu bewältigen wäre.

| Predicted | Gold |
|---|---|
| `Urs Ahrenholz` | `Urs Ahrenholz` |

**Example 71** (doc_id: `deanon_BFG_20260814_TRAIN/145910.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145910.1_44`)


Es liegen über die gesamten  Zeiträume Stundenaufzeichnungen vor und es existiert auch eine Tätigkeitsbeschreibung (siehe  Anlage 1 Stellungnahme von Herrn Urs Ahrenholz  und Frau A. zum Tätigkeitsfeld in der  Versicherungsagentur).

| Predicted | Gold |
|---|---|
| `Urs Ahrenholz` | `Urs Ahrenholz` |

**Example 72** (doc_id: `deanon_BFG_20260814_TRAIN/145910.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145910.1_45`)
...
**Example 73** (doc_id: `deanon_BFG_20260814_TRAIN/145910.1`) (sent_id: `deanon_BFG_20260814_TRAIN/145910.1_58`)


Herr Urs Ahrenholz  war dies nicht bewusst, deshalb hat die  Lohnverrechnung dieses Gehalt durch 14 dividiert (Sonderzahlungen), sodass dann gerundet  der Betrag von € 376,- resultierte.

| Predicted | Gold |
|---|---|
| `Urs Ahrenholz` | `Urs Ahrenholz` |

**Example 74** (doc_id: `deanon_BFG_20260814_TRAIN/146475.1`) (sent_id: `deanon_BFG_20260814_TRAIN/146475.1_2`)


Herrn Senta Nettekoven, geb. am 1960, Im Reintal 37, 2152 Eichenbrunn, Österreich  2. Springholz, Am Schloßgraben 71, 4802 Langwies, Österreich   beide vertreten durch HPS Hergovits, Pinkel & Schnabl Steuerberatungs GmbH, Triesterstraße  14, 2351 Wiener Neudorf,   wegen der Finanzvergehen der Abgabenhinterziehungen und Finanzordnungswidrigkeiten  gemäß §§ 33 Abs. 1 und Abs. 2 lit. a und 49 Abs. 1 lit. a FinStrG des Finanzstrafgesetzes  (FinStrG) über die Beschwerden des Beschuldigten und des belangten Verbandes jeweils vom  7. August 2024 gegen das Erkenntnis des Spruchsenates beim Amt für Betrugsbekämpfung als  Finanzstrafbehörde vom 28. Mai 2024, Geschäftszahl SpS-1, in der Sitzung am 10. Dezember  2024 in Anwesenheit der Schriftführerin zu Recht erkannt:  1.

| Predicted | Gold |
|---|---|
| `Senta Nettekoven` | `Senta Nettekoven` |

**Missed by this rule (FN):**

- `Im Reintal 37, 2152 Eichenbrunn, Österreich` (address)
- `Springholz` (organisation)
- `Am Schloßgraben 71, 4802 Langwies, Österreich` (address)
- `HPS Hergovits, Pinkel & Schnabl Steuerberatungs GmbH` (organisation)
- `Amt für Betrugsbekämpfung` (organisation)

**Example 75** (doc_id: `deanon_BFG_20260814_TRAIN/146475.1`) (sent_id: `deanon_BFG_20260814_TRAIN/146475.1_13`)
...
**Example 2** (doc_id: `deanon_BFG_20260814_TRAIN/129336.1`) (sent_id: `deanon_BFG_20260814_TRAIN/129336.1_134`)
...
**Example 8** (doc_id: `deanon_BFG_20260814_TRAIN/132647.1`) (sent_id: `deanon_BFG_20260814_TRAIN/132647.1_171`)
...
**Example 9** (doc_id: `deanon_BFG_20260814_TRAIN/132794.1`) (sent_id: `deanon_BFG_20260814_TRAIN/132794.1_7`)
...
**Example 10** (doc_id: `deanon_BFG_20260814_TRAIN/132794.1`) (sent_id: `deanon_BFG_20260814_TRAIN/132794.1_10`)
...
**Example 11** (doc_id: `deanon_BFG_20260814_TRAIN/132794.1`) (sent_id: `deanon_BFG_20260814_TRAIN/132794.1_11`)
...
**Example 12** (doc_id: `deanon_BFG_20260814_TRAIN/132794.1`) (sent_id: `deanon_BFG_20260814_TRAIN/132794.1_101`)
...
**Example 13** (doc_id: `deanon_BFG_20260814_TRAIN/134399.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134399.1_28`)
...
**Example 14** (doc_id: `deanon_BFG_20260814_TRAIN/134399.1`) (sent_id: `deanon_BFG_20260814_TRAIN/134399.1_35`)
...
**Example 15** (doc_id: `deanon_BFG_20260814_TRAIN/137291.1`) (sent_id: `deanon_BFG_20260814_TRAIN/137291.1_18`)
...
**Example 16** (doc_id: `deanon_BFG_20260814_TRAIN/138082.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138082.1_28`)
...
**Example 17** (doc_id: `deanon_BFG_20260814_TRAIN/138377.1`) (sent_id: `deanon_BFG_20260814_TRAIN/138377.1_16`)


Im Aktenvermerk der belangten Behörde datierend mit 22.08.2019 wird der Inhalt eines  Telefongespräches zwischen der zuständigen Sachbearbeiterin und dem Ehemann der Bf.,  Herrn GatteW, vom selben Tag festgehalten;
...
**Example 18** (doc_id: `deanon_BFG_20260814_TRAIN/140556.1`) (sent_id: `deanon_BFG_20260814_TRAIN/140556.1_129`)
...
**Example 19** (doc_id: `deanon_BFG_20260814_TRAIN/141663.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141663.1_120`)
...
**Example 20** (doc_id: `deanon_BFG_20260814_TRAIN/141663.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141663.1_133`)
...
**Example 21** (doc_id: `deanon_BFG_20260814_TRAIN/141663.1`) (sent_id: `deanon_BFG_20260814_TRAIN/141663.1_138`)
...
**Example 22** (doc_id: `deanon_BFG_20260814_TRAIN/142383.1`) (sent_id: `deanon_BFG_20260814_TRAIN/142383.1_13`)
